(function () {
    ...
    var k = void 0, l = !0, m = null, n = !1, p, r = this;
    function s(a) {
        a = a.split(".");
        ...
        for (var c = 0, d = ua(String(a)).split("."), e = ua(String(b)).split("."), f = Math.max(d.length, e.length), h = 0; 0 == c && h < f; h++) {
            ...
            do {
                ...
                if (0 == F[0].length && 0 == I[0].length)
                    break;
                c = ((0 == F[1].length ? 0 : parseInt(F[1], 10)) < (0 == I[1].length ? 0 : parseInt(I[1], 10)) ? -1 : (0 == F[1].length ? 0 : parseInt(F[1], 10)) > (0 == I[1].length ? 0 : parseInt(I[1], 10)) ? 1 : 0) || ((0 == F[2].length) < (0 == I[2].length) ? -1 : (0 == F[2].length) > (0 == I[2].length) ? 1 : 0) || (F[2] < I[2] ? -1 : F[2] > I[2] ? 1 : 0)
            } while (0 == c)
        }
        return c
    }
    ; var Ha = Array.prototype
        ...
        , Ja = Ha.filter ? function (a, b, c) {
            ...
            : function (a, b, c) {
                for (var d = a.length, e = [], f = 0, h = ga(a) ? a.split("") : a, j = 0; j < d; j++)
                    if (j in h) {
                        var q = h[j];
        ...
        , Ka = Ha.map ? function (a, b, c) {
            ...
            : function (a, b, c) {
                for (var d = a.length, e = Array(d), f = ga(a) ? a.split("") : a, h = 0; h < d; h++)
    ...
    function Va(a, b, c, d) {
        Ha.splice.apply(a, Wa(arguments, 1))
    }
    function Wa(a, b, c) {
    ...
    function bb(a, b, c) {
        for (var d = Za(a), e = n, f = 0; f < d.length; f++)
            d[f] == b && (Va(d, f--, 1),
                e = l);
        e && (d.push(c),
            a.className = d.join(" "))
    ...
    function A(a, b, c) {
        var d = Za(a);
        ga(b) ? Qa(d, b) : ea(b) && (d = ab(d, b));
        ga(c) && !Na(d, c) ? d.push(c) : ea(c) && $a(d, c);
        a.className = d.join(" ")
    }
    function B(a, b) {
        return Na(Za(a), b)
    ...
    db.prototype.ma = function () {
        return new db(this.x, this.y)
    }
        ;
    function eb(a, b) {
        return new db(a.x - b.x, a.y - b.y)
    }
    ; function fb(a, b) {
        this.width = a;
        this.height = b
    ...
    if (vb = tb()) {
        var wb = ub();
        nb = 0 == vb.indexOf("Opera");
        ob = !nb && -1 != vb.indexOf("MSIE");
        pb = !nb && -1 != vb.indexOf("WebKit");
        qb = !nb && !pb && "Gecko" == wb.product
    }
    var xb = nb
        , D = ob
        , yb = qb
    ...
    rb = -1 != Bb.indexOf("Mac");
    sb = -1 != Bb.indexOf("Win");
    var Cb = !!ub() && -1 != (ub().appVersion || "").indexOf("X11");
    function Db() {
        var a = r.document;
    ...
    a: {
        var Fb = "", Gb;
        if (xb && r.opera)
            var Hb = r.opera.version
                , Fb = "function" == typeof Hb ? Hb() : Hb;
        else if (yb ? Gb = /rv\:([^\);]+)(\)|;)/ : D ? Gb = /MSIE\s+([^\);]+)(\)|;)/ : zb && (Gb = /WebKit\/(\S+)/),
            Gb)
            var Ib = Gb.exec(tb())
                , Fb = Ib ? Ib[1] : "";
        if (D) {
    ...
    var Kb = Eb
        , Lb = {};
    function Mb(a) {
        return Lb[a] || (Lb[a] = 0 <= Ga(Kb, a))
    }
    var Nb = r.document
        , Ob = !Nb || !D ? k : Db() || ("CSS1Compat" == Nb.compatMode ? parseInt(Kb, 10) : 5);
    var Pb = !D || D && 9 <= Ob;
    !yb && !D || D && D && 9 <= Ob || yb && Mb("1.9.1");
    var Qb = D && !Mb("9");
    function Rb(a) {
        return a ? new Sb(Tb(a)) : Ya || (Ya = new Sb)
    }
    function E(a) {
    ...
    function K(a, b) {
        var c = b || document
            , d = m;
        return (d = c.querySelectorAll && c.querySelector ? c.querySelector("." + a) : H(a, b)[0]) || m
    }
    function J(a, b, c) {
        var d = document;
        c = c || d;
        ...
        if (b) {
            ...
            for (f = e = 0; h = c[f]; f++)
                a = h.className,
                    "function" == typeof a.split && Na(a.split(/\s+/), b) && (d[e++] = h);
            d.length = e;
            return d
        }
        return c
    ...
    function Vb(a) {
        a = a.document;
        a = Wb(a) ? a.documentElement : a.body;
    ...
    function Yb(a) {
        var b = !zb && Wb(a) ? a.documentElement : a.body;
        a = a.parentWindow || a.defaultView;
        return new db(a.pageXOffset || b.scrollLeft, a.pageYOffset || b.scrollTop)
    }
    function Zb(a, b, c) {
    ...
    function $b(a, b) {
        ...
        d && (ga(d) ? f.className = d : ea(d) ? y.apply(m, [f].concat(d)) : gb(d, function (a, b) {
            "style" == b ? f.style.cssText = a : "class" == b ? f.className = a : "for" == b ? f.htmlFor = a : b in Ub ? f.setAttribute(Ub[b], a) : 0 == b.lastIndexOf("aria-", 0) || 0 == b.lastIndexOf("data-", 0) ? f.setAttribute(b, a) : f[b] = a
        }));
        2 < b.length && ac(a, f, b, 2);
        return f
    }
    function ac(a, b, c, d) {
        function e(c) {
    ...
    function fc(a) {
        return a.firstElementChild != k ? a.firstElementChild : gc(a.firstChild)
    }
    function gc(a) {
        for (; a && 1 != a.nodeType;)
            a = a.nextSibling;
    ...
    function kc(a, b) {
        if ("textContent" in a)
            ...
            dc(a),
                a.appendChild(Tb(a).createTextNode(b))
    }
    function lc(a, b, c, d) {
        if (a != m)
    ...
    function pc(a, b, c) {
        if (!(a.nodeName in mc))
            ...
            else if (a.nodeName in nc)
                b.push(nc[a.nodeName]);
            else
                for (a = a.firstChild; a;)
                    pc(a, b, c),
                        a = a.nextSibling
    ...
    p.appendChild = function (a, b) {
        ...
        ;
    p.contains = jc;
    var wc = "StopIteration" in r ? r.StopIteration : Error("StopIteration");
    function xc() { }
    ...
    p.clear = function () {
        ...
        ;
    p.remove = function (a) {
        return Object.prototype.hasOwnProperty.call(this.e, a) ? (delete this.e[a],
            this.Q--,
            this.Eb++,
            this.b.length > 2 * this.Q && Bc(this),
            l) : n
    }
        ;
    function Bc(a) {
    ...
    p.get = function (a, b) {
        ...
        ;
    p.set = function (a, b) {
        Object.prototype.hasOwnProperty.call(this.e, a) || (this.Q++,
            this.b.push(a),
            this.Eb++);
        this.e[a] = b
    }
    ...
    ; var Ic = /<[^>]*>|&[^;]+;/g
        , Jc = RegExp("^[^\u0591-\u07ff\ufb1d-\ufdff\ufe70-\ufefc]*[A-Za-z\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02b8\u0300-\u0590\u0800-\u1fff\u2c00-\ufb1c\ufe00-\ufe6f\ufefd-\uffff]")
        , Kc = RegExp("^[^A-Za-z\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02b8\u0300-\u0590\u0800-\u1fff\u2c00-\ufb1c\ufe00-\ufe6f\ufefd-\uffff]*[\u0591-\u07ff\ufb1d-\ufdff\ufe70-\ufefc]");
    function Lc(a, b) {
        return Kc.test(b ? a.replace(Ic, " ") : a)
    }
    ; var Mc = window.yt && window.yt.config_ || {};
    u("yt.config_", Mc);
    var Nc = window.yt && window.yt.tokens_ || {};
    u("yt.tokens_", Nc);
    var Oc = window.yt && window.yt.globals_ || {};
    u("yt.globals_", Oc);
    var Pc = window.yt && window.yt.msgs_ || {};
    u("yt.msgs_", Pc);
    var Qc = window.yt && window.yt.timeouts_ || [];
    u("yt.timeouts_", Qc);
    var Rc = window.yt && window.yt.intervals_ || [];
    u("yt.intervals_", Rc);
    function Sc(a) {
        Tc(Mc, arguments)
    }
    function L(a, b) {
        return a in Mc ? Mc[a] : b
    }
    function Uc(a) {
        Tc(Nc, arguments)
    }
    function M(a) {
        return a in Nc ? Nc[a] : k
    }
    function Vc(a) {
    ...
    ; function cd(a, b, c) {
        a.dataset ? a.dataset[dd(b)] = c : a.setAttribute("data-" + b, c)
    }
    function P(a, b) {
        return a.dataset ? a.dataset[dd(b)] : a.getAttribute("data-" + b)
    }
    function ed(a, b) {
        a.dataset ? delete a.dataset[dd(b)] : a.removeAttribute("data-" + b)
    }
    function fd(a, b) {
        return a.dataset ? dd(b) in a.dataset : a.hasAttribute ? !!a.hasAttribute("data-" + b) : !!a.getAttribute("data-" + b)
    }
    var gd = {};
    function dd(a) {
        return gd[a] || (gd[a] = String(a).replace(/\-([a-z])/g, function (a, c) {
    ...
    var id = s("yt.dom.getNextId_");
    if (!id) {
        id = function () {
            return ++jd
        }
            ;
        u("yt.dom.getNextId_", id);
        var jd = 0
    }
    function kd(a) {
        var b = a.cloneNode(n);
        ...
        if (a = a || window.event) {
            ...
            "MozMousePixelScroll" == this.type ? (this.wheelDeltaX = a.axis == a.HORIZONTAL_AXIS ? a.detail : 0,
                this.wheelDeltaY = a.axis == a.HORIZONTAL_AXIS ? 0 : a.detail) : window.opera ? (this.wheelDeltaX = 0,
                    this.wheelDeltaY = a.detail) : 0 == a.wheelDelta % 120 ? "WebkitTransform" in document.documentElement.style ? window.b && 0 == navigator.platform.indexOf("Mac") ? (this.wheelDeltaX = a.wheelDeltaX / -30,
    ...
    var sd = s("yt.events.listeners_") || {};
    u("yt.events.listeners_", sd);
    var td = s("yt.events.counter_") || {
        count: 0
    };
    u("yt.events.counter_", td);
    function ud(a, b, c, d) {
        return jb(sd, function (e) {
    ...
    function Q(a, b, c, d) {
        ...
        if (e)
            return e;
        var e = ++td.count + "", f = !(!("mouseenter" == b || "mouseleave" == b) || !a.addEventListener || "onmouseenter" in document), h;
        h = f ? function (d) {
            d = new qd(d);
            if (!sc(d.relatedTarget, function (b) {
                return b == a
            }, l))
    ...
    p.set = function (a, b, c, d, e, f) {
        ...
        ;
    p.get = function (a, b) {
        for (var c = a + "=", d = (this.b.cookie || "").split(Dd), e = 0, f; f = d[e]; e++) {
    ...
    p.sd = function () {
        ...
        ;
    p.ea = function () {
        return !this.b.cookie ? 0 : (this.b.cookie || "").split(Dd).length
    }
        ;
    p.clear = function () {
    ...
    var Fd = new Cd(document);
    Fd.e = 3950;
    function Gd(a, b, c, d, e) {
        Fd.set("" + a, b, c, d || "/", e || "youtube.com")
    }
    function Hd(a, b) {
        return Fd.get("" + a, b)
    }
    function Id(a, b, c) {
        return Fd.remove("" + a, b || "/", c || "youtube.com")
    }
    ; function Jd() {
        var a = Hd("PREF");
        if (a)
            for (var a = unescape(a).split("&"), b = 0; b < a.length; b++) {
                var c = a[b].split("=")
                    , d = c[0];
                (c = c[1]) && (Kd[d] = c.toString())
            }
    }
    ba(Jd);
    var Kd = s("yt.prefs.UserPrefs.prefs_") || {};
    u("yt.prefs.UserPrefs.prefs_", Kd);
    function Ld(a) {
    ...
    Jd.prototype.set = function (a, b) {
        ...
        ;
    function Od(a, b) {
        return !!((Nd("f" + (Math.floor(b / 31) + 1)) || 0) & 1 << b % 31)
    }
    function Pd(a, b) {
        var c = "f" + (Math.floor(a / 31) + 1)
            ...
            , e = Nd(c) || 0
            , e = b ? e | d : e & ~d;
        0 == e ? delete Kd[c] : (d = e.toString(16),
            Kd[c] = d.toString())
    }
    ...
    function Qd() {
        var a = [], b;
        for (b in Kd)
            a.push(b + "=" + escape(Kd[b]));
        Gd("PREF", a.join("&"), 31536E4)
    }
    ...
    Sd.prototype.contains = function (a) {
        return !this || !a ? n : a instanceof Sd ? a.left >= this.left && a.right <= this.right && a.top >= this.top && a.bottom <= this.bottom : a.x >= this.left && a.x <= this.right && a.y >= this.top && a.y <= this.bottom
    }
        ;
    function Td(a, b, c, d) {
        this.left = a;
    ...
    function Vd(a, b, c) {
        ...
        a: if (d = String(c).replace(/\-([a-z])/g, function (a, b) {
            ...
            a.style[d] === k) {
            var e = zb ? "Webkit" : yb ? "Moz" : D ? "ms" : xb ? "O" : m
    ...
    function Xd(a, b) {
        return Wd(a, b) || (a.currentStyle ? a.currentStyle[b] : m) || a.style && a.style[b]
    }
    function Yd(a) {
    ...
    function $d(a) {
        for (var b = new Sd(0, Infinity, Infinity, 0), c = Rb(a), d = c.b.body, e = c.b.documentElement, f = !zb && Wb(c.b) ? c.b.documentElement : c.b.body; a = Zd(a);)
            if ((!D || 0 != a.clientWidth) && (!zb || 0 != a.clientHeight || a != d) && a != d && a != e && "visible" != Xd(a, "overflow")) {
                var h = ae(a), j;
                j = a;
                if (yb && !Mb("1.9")) {
                    var q = parseFloat(Wd(j, "borderLeftWidth"));
                    if (be(j))
                        var v = j.offsetWidth - j.clientWidth - q - parseFloat(Wd(j, "borderRightWidth"))
                            , q = q + v;
                    j = new db(q, parseFloat(Wd(j, "borderTopWidth")))
                } else
                    j = new db(j.clientLeft, j.clientTop);
                h.x += j.x;
                h.y += j.y;
        ...
        c = Vb(c.b.parentWindow || c.b.defaultView || window);
    ...
    function ae(a) {
        var b, c = Tb(a), d = Xd(a, "position"), e = yb && c.getBoxObjectFor && !a.getBoundingClientRect && "absolute" == d && (b = c.getBoxObjectFor(a)) && (0 > b.screenX || 0 > b.screenY), f = new db(0, 0), h;
        b = c ? Tb(c) : document;
        h = D && !(D && 9 <= Ob) && !uc(Rb(b)) ? b.body : b.documentElement;
        if (a == h)
            return f;
    ...
    function ee(a) {
        ...
        if (1 == a.nodeType) {
            ...
            if (yb && !Mb(12)) {
                var e;
                D ? e = "-ms-transform" : zb ? e = "-webkit-transform" : xb ? e = "-o-transform" : yb && (e = "-moz-transform");
                var f;
                e && (f = Xd(a, e));
                f || (f = Xd(a, "transform"));
                f ? (a = f.match(fe),
                    a = !a ? new db(0, 0) : new db(parseFloat(a[1]), parseFloat(a[2]))) : a = new db(0, 0);
                b = new db(b.x + a.x, b.y + a.y)
            }
        } else
            e = ha(a.Sg),
                f = a,
                a.targetTouches ? f = a.targetTouches[0] : e && a.Ka.targetTouches && (f = a.Ka.targetTouches[0]),
                b.x = f.clientX,
                b.y = f.clientY;
        return b
    }
    ...
    function ie(a) {
        var b = a.offsetWidth
            , c = a.offsetHeight
            , d = zb && !b && !c;
        return (!da(b) || d) && a.getBoundingClientRect ? (a = Yd(a),
            new fb(a.right - a.left, a.bottom - a.top)) : new fb(b, c)
    }
    function je(a) {
        var b = ae(a);
        a = he(a);
    ...
    function de(a) {
        if (D) {
            var b = ne(a, "borderLeft")
                ...
                , d = ne(a, "borderTop");
            a = ne(a, "borderBottom");
            return new Sd(d, c, a, b)
        }
        b = Wd(a, "borderLeftWidth");
        c = Wd(a, "borderRightWidth");
        d = Wd(a, "borderTopWidth");
        a = Wd(a, "borderBottomWidth");
        return new Sd(parseFloat(d), parseFloat(c), parseFloat(a), parseFloat(b))
    }
    ...
    function qe(a) {
        if (a = E(a))
            pe(a) ? (a.style.display = "none",
                y(a, "hid")) : (a.style.display = "",
                    z(a, "hid"))
    }
    function re(a, b) {
        if (a = E(a))
    ...
    var xe = zb;
    function ye(a) {
        return (a = we(a)[3] || m) && decodeURIComponent(a)
    }
    function ze() {
        var a = we(document.location.href);
        return ue(a[1], a[2], a[3], a[4])
    }
    function Ae(a) {
        a = we(a);
        return ue(m, m, m, m, a[5], a[6], a[7])
    }
    function Be(a) {
        var b = a.indexOf("#");
    ...
    function De(a, b, c) {
        if (ea(b))
            ...
            b != m && c.push("&", a, "" === b ? "" : "=", encodeURIComponent(String(b)))
    }
    function Ee(a, b, c) {
    ...
    function Ge(a, b) {
        return Ce(2 == arguments.length ? Ee([a], arguments[1], 0) : Ee([a], arguments, 1))
    }
    var He = /#|$/;
    function Ie(a, b) {
        var c = a.search(He), d;
    ...
    ; function Je(a) {
        ...
        for (var b = {}, c = 0, d = a.length; c < d; c++) {
            ...
            if (1 == e.length && e[0] || 2 == e.length) {
                var f = wa(e[0] || "")
                    , e = wa(e[1] || "");
                f in b ? ea(b[f]) ? Ua(b[f], e) : b[f] = [b[f], e] : b[f] = e
            }
        }
        return b
    }
    ...
    ; function Te(a) {
        ...
        this.args = a.args || kb(Ue);
        this.assets = a.assets || {};
        this.attrs = a.attrs || kb(Ve);
        this.params = a.params || kb(We);
    ...
    function Ze(a, b, c, d) {
        ...
        return a.X > b[0] || a.X == b[0] && a.$a > b[1] || a.X == b[0] && a.$a == b[1] && a.Jb >= b[2]
    }
    function $e(a) {
        return -1 < a.Sc.indexOf("Gnash") && -1 == a.Sc.indexOf("AVM2") || 9 == a.X && 1 == a.$a || 9 == a.X && 0 == a.$a && 1 == a.Jb ? n : 9 <= a.X
    }
    function af(a) {
        return -1 < navigator.userAgent.indexOf("Sony/COM2") && !Ze(a, 9, 1, 58) ? n : l
    }
    function Ye(a) {
        if (3 > a.Ga)
            if (1 > a.Ga) {
                ...
                var I = t(a.Xd, a)
                    , R = 0
                    , Da = function () {
                        if (j && "GetVariable" in j)
                            try {
                                q = j.GetVariable("$version")
                            } catch (a) {
                                q = ""
                            }
                        q || 10 <= R ? (v && G && v.removeChild(G),
                            I(q || "")) : (R++,
                                N(Da, 10))
                    };
                N(Da, 0)
    ...
    ; function cf(a, b, c) {
        if ((a = E(a)) && b && c) {
            c instanceof Te || (c = new Te(c));
            var d = kb(c.attrs);
            d.tabindex = 0;
            var e = kb(c.params);
            e.flashvars = Me(c.args);
            if ($c) {
    ...
    function df(a, b) {
        ...
        ef(function (c) {
            Ze(c, b.minVersion) || L("IS_OPERA_MINI") ? (c = $e(c) && b.url || af(c) && b.urlV9As2 || b.urlV8 || b.url,
                cf(a, c, b)) : 0 == c.X && b.fallback ? b.fallback() : 0 == c.X && b.fallbackMessage ? b.fallbackMessage() : a.innerHTML = '<div id="flash-upgrade">' + O("FLASH_UPGRADE", k, 'You need to upgrade your Adobe Flash Player to watchthis video. <br> <a href="http://get.adobe.com/flashplayer/">Download it from Adobe.</a>') + "</div>"
        })
    }
    function ff(a, b, c) {
        if (a) {
            a instanceof Te || (a = new Te(a));
            var d = !!b
                , e = E(a.attrs.id)
                , f = e ? e.parentNode : m;
            if (!e || !f)
                ...
                ef(function (b) {
                    if (Ze(b, a.minVersion)) {
                        var h = "";
                        -1 < navigator.userAgent.indexOf("Sony/COM2") || (h = e.getAttribute("src") || e.movie);
                        $e(b) ? (h != a.url || d) && cf(f, a.url, a) : af(b) ? (h != a.urlV9As2 || d) && cf(f, a.urlV9As2, a) : (h != a.urlV8 || d) && cf(f, a.urlV8, a);
                        if (sb ? !Ze(b, 11, 2) : rb ? !Ze(b, 11, 3) : !$e(b))
                            b = E("flash10-promo-div"),
                                h = Od(Jd.getInstance(), Rd.be),
                                b && !h && T(b)
                    } else
                        0 == b.X && a.fallback ? a.fallback() : 0 == b.X && a.fallbackMessage ? a.fallbackMessage() : f.innerHTML = '<div id="flash-upgrade">' + O("FLASH_UPGRADE") + "</div>";
                    c && c()
                })
            }
        }
    ...
    function ef(a) {
        Xe.getInstance().load(function (b) {
            Jd.getInstance().set("fv", b.getVersion().join("."));
            Qd();
            a(b)
        })
    }
    ...
    function hf(a) {
        for (var b = 0, c = arguments.length; b < c; ++b) {
            var d = arguments[b];
            fa(d) ? hf.apply(m, d) : d && "function" == typeof d.ra && d.ra()
        }
    }
    ; function jf() {
        this.b = [];
    ...
    p.va = function (a, b) {
        ...
        if (c) {
            this.ac++;
            for (var d = Wa(arguments, 1), e = 0, f = c.length; e < f; e++) {
                var h = c[e];
    ...
    p.W = function () {
        ...
        ;
    var kf = s("yt.pubsub.instance_") || new jf;
    jf.prototype.subscribe = jf.prototype.Ta;
    jf.prototype.unsubscribeByKey = jf.prototype.$b;
    jf.prototype.publish = jf.prototype.va;
    jf.prototype.clear = jf.prototype.clear;
    u("yt.pubsub.instance_", kf);
    function V(a, b, c) {
    ...
    var pf = D && 8 <= document.documentMode || yb && Mb("1.9.2") || zb && Mb("532.1")
        , of = D && !pf;
    nf.prototype.ba = function (a, b) {
        this.i && (wd(this.i),
            delete this.i);
        this.z && (Yc(this.z),
            delete this.z);
        if (a) {
            ...
            if (of) {
                ...
                (!c || !c.innerHTML) && rf(this, this.b)
            }
            b || this.e(this.b);
            pf ? this.i = Q(this.N, "hashchange", this.H) : this.z = Wc(this.H, 200)
        }
    }
        ;
    ...
    function rf(a, b) {
        ...
        if ((c.body ? c.body.innerHTML : "") != d)
            d = ["<title>", xa(window.document.title || ""), "</title><body>", d, "</body>"],
                c.open("text/html"),
                c.write(d.join("")),
                c.close()
    }
    nf.prototype.add = function (a, b, c) {
        this.b = "" + a;
        of && rf(this, a);
        sf(this, a);
        c || this.e(this.b)
    ...
    var vf = !!window.history.pushState && (!zb || zb && Mb("534.11"));
    uf.prototype.T = function (a, b) {
        this.k && (wd(this.k),
            delete this.k);
        this.z && (Yc(this.z),
            delete this.z);
        a && vf && (this.b = this.e.href,
            b || this.g(this.b),
            this.k = Q(this.i, "popstate", this.H))
    }
        ;
    uf.prototype.N = function (a) {
        var b = this.e.href;
        ...
        ;
    uf.prototype.add = function (a, b, c) {
        if (a || b)
            a = a || this.e.href,
        ...
        ;
    uf.prototype.replace = function (a, b, c) {
        if (a || b)
            a = a || this.e.href,
                this.i.history.replaceState(b, "", a),
                this.b = a,
                c || this.g(a, b)
    }
        ;
    function wf(a) {
        ...
        b || ("state" == a ? (b = new uf(xf),
            uf.prototype.setEnabled = uf.prototype.T,
            uf.prototype.add = uf.prototype.add,
            uf.prototype.replace = uf.prototype.replace) : (b = new nf(xf, E("legacy-history-iframe")),
                nf.prototype.setEnabled = nf.prototype.ba,
                nf.prototype.add = nf.prototype.add,
                nf.prototype.replace = nf.prototype.add),
            mf = b,
            u("yt.history.instance_", mf));
        return b
    }
    function xf(a, b) {
        W("navigate", a, b)
            ...
            case "object":
                ...
                if (ea(b)) {
                    ...
                    for (var e = "", f = 0; f < d; f++)
                        c.push(e),
                            e = b[f],
                            Cf(a, a.b ? a.b.call(b, String(f), e) : e, c),
                            e = ",";
                    c.push("]");
                    break
                }
    ...
    var Ef = {
        ...
        , Ff = /\uffff/.test("\uffff") ? /[\\\"\x00-\x1f\x7f-\uffff]/g : /[\\\"\x00-\x1f\x7f-\xff]/g;
    function Df(a, b) {
        b.push('"', a.replace(Ff, function (a) {
            if (a in Ef)
                return Ef[a];
            var b = a.charCodeAt(0)
                , e = "\\u";
            16 > b ? e += "000" : 256 > b ? e += "00" : 4096 > b && (e += "0");
            return Ef[a] = e + b.toString(16)
        }), '"')
    }
    ; var Gf = m;
    "undefined" != typeof XMLHttpRequest ? Gf = function () {
        return new XMLHttpRequest
    }
        : "undefined" != typeof ActiveXObject && (Gf = function () {
            ...
            if (e)
                for (var j in e)
                    h.setRequestHeader(j, e[j]),
                        "content-type" == j.toLowerCase() && (a = n);
                ...
                if (d || 400 <= a.status && 500 > a.status) {
                    ...
                    switch (c) {
                        case "JSON":
                            ...
                            e && 0 <= I.indexOf("json") && (j = zf(e));
                            break;
                        case "XML":
                            if (e = (e = a.responseXML) ? Jf(e) : m)
                                j = {},
                                    x(e.getElementsByTagName("*"), function (a) {
                                        j[a.tagName] = Kf(a)
                                    })
                    }
                    e = j
    ...
    function Mf(a, b) {
        ...
        return If(a, function (a) {
            if (Hf(a)) {
                var b = a.responseXML, v = b ? Jf(b) : m, b = !(!b || !v), G, F;
                if (b && (G = Nf(v, "return_code"),
                    F = Nf(v, "html_content"),
                    0 == G)) {
                    f && F && (E(f).innerHTML = F);
                    var I = Nf(v, "js_content");
                    if (I) {
                ...
                c && (b ? (b = Nf(v, "redirect_on_success"),
                    G && b ? window.location = b : ((v = Nf(v, 0 == G ? "success_message" : "error_message")) && alert(v),
                        a = h ? eval("(" + F + ")") : a,
                        0 == G ? c(a) : d && d(a))) : a.responseText && c(a))
            } else
                e && e(a)
    ...
    function Uf(a, b) {
        ...
        var c = b || ja(a)
            , d = Rf[c];
        d && (Rf[c] = Ja(d, function (b) {
            return b[0] != a
        }))
    }
    function Vf(a) {
        a in Rf && !Sf[a] && (x(Rf[a], function (a) {
            var c = a[0];
            a = a[1];
    ...
    ; function Xf(a, b) {
        if (a in Yf)
            for (var c = Yf[a], d = Array.prototype.slice.call(arguments, 1), e = 0, f = c.length; e < f; e++)
                c[e] && c[e][0].apply(c[e][1], d)
    }
    var Yf = {};
    function Zf(a) {
    ...
    ; var cg, dg, eg, fg, gg, hg, ig;
    ig = hg = gg = fg = eg = dg = cg = n;
    var jg = tb();
    jg && (-1 != jg.indexOf("Firefox") ? cg = l : -1 != jg.indexOf("Camino") ? dg = l : -1 != jg.indexOf("iPhone") || -1 != jg.indexOf("iPod") ? eg = l : -1 != jg.indexOf("iPad") ? fg = l : -1 != jg.indexOf("Android") ? gg = l : -1 != jg.indexOf("Chrome") ? hg = l : -1 != jg.indexOf("Safari") && (ig = l));
    var kg = cg
        , lg = dg
        , mg = eg
        , ng = fg
    ...
    function rg(a, b) {
        var c = ye(a);
        if (c == ye(window.location.href) || !c && 0 == a.lastIndexOf("/", 0))
            if (c = Ae(a),
                c = Be(c)) {
                for (var d = 0, e = 0; e < c.length; ++e)
                    d = 31 * d + c.charCodeAt(e),
                        d %= 4294967296;
                c = "s_tempdata-" + d;
                d = b ? Me(b) : "";
                Gd(c, d, 5)
    ...
    ; function zg(a, b, c, d, e, f, h) {
        ...
        if (j = c.offsetParent) {
            ...
            if (!v || "static" != Xd(j, "position"))
                q = ae(j),
                    v || (v = (v = be(j)) && yb ? -j.scrollLeft : v && (!D || !Mb("8")) ? j.scrollWidth - j.clientWidth - j.scrollLeft : j.scrollLeft,
                        q = eb(q, new db(v, j.scrollTop)))
        }
        j = q || new db;
        q = je(a);
        if (v = $d(a)) {
            var G = new Td(v.left, v.top, v.right - v.left, v.bottom - v.top)
                , v = Math.max(q.left, G.left)
                , F = Math.min(q.left + q.width, G.left + G.width);
            if (v <= F) {
                var I = Math.max(q.top, G.top)
                    , G = Math.min(q.top + q.height, G.top + G.height);
                I <= G && (q.left = v,
                    q.top = I,
                    q.width = F - v,
                    q.height = G - I)
        ...
        if (v.b != I.b) {
            var F = v.b.body
                ...
                , G = new db(0, 0)
                , R = Tb(F) ? Tb(F).parentWindow || Tb(F).defaultView : window
                , Da = F;
            do {
                var pa = R == I ? ae(Da) : ee(Da);
                G.x += pa.x;
                G.y += pa.y
            } while (R && R != I && (Da = R.frameElement) && (R = R.parent));
            F = eb(G, ae(F));
            D && !uc(v) && (F = eb(F, vc(v)));
            q.left += F.x;
            q.top += F.y
        ...
        a = (b & 4 && be(a) ? b ^ 2 : b) & -5;
        b = new db(a & 2 ? q.left + q.width : q.left, a & 1 ? q.top + q.height : q.top);
        b = eb(b, j);
        e && (b.x += (a & 2 ? -1 : 1) * e.x,
            b.y += (a & 1 ? -1 : 1) * e.y);
        var Z;
    ...
    function Ag(a, b, c, d, e, f, h) {
        ...
        h = h ? h.ma() : c.ma();
        if (d || 0 != q)
            q & 2 ? a.x -= h.width + (d ? d.right : 0) : d && (a.x += d.left),
                q & 1 ? a.y -= h.height + (d ? d.bottom : 0) : d && (a.y += d.top);
        if (f) {
            if (e) {
                j = a;
                d = 0;
                ...
                j.x < e.left && f & 1 && (j.x = e.left,
                    d |= 1);
                j.x < e.left && (j.x + h.width > e.right && f & 16) && (h.width = Math.max(h.width - (j.x + h.width - e.right), 0),
                    d |= 4);
                j.x + h.width > e.right && f & 1 && (j.x = Math.max(e.right - h.width, e.left),
                    d |= 1);
                f & 2 && (d |= (j.x < e.left ? 16 : 0) | (j.x + h.width > e.right ? 32 : 0));
                j.y < e.top && f & 4 && (j.y = e.top,
                    d |= 2);
                j.y >= e.top && (j.y + h.height > e.bottom && f & 32) && (h.height = Math.max(h.height - (j.y + h.height - e.bottom), 0),
                    d |= 8);
                j.y + h.height > e.bottom && f & 4 && (j.y = Math.max(e.bottom - h.height, e.top),
                    d |= 2);
        ...
        f = a;
        e = yb && (rb || Cb) && Mb("1.9");
        f instanceof db ? (a = f.x,
            f = f.y) : (a = f,
                f = k);
        b.style.left = ge(a, e);
        b.style.top = ge(f, e);
        if (!(c == h || (!c || !h ? 0 : c.width == h.width && c.height == h.height)))
            a = uc(Rb(Tb(b))),
                D && (!a || !Mb("8")) ? (c = b.style,
                    a ? (D ? (a = le(b, "paddingLeft"),
                        e = le(b, "paddingRight"),
                        f = le(b, "paddingTop"),
                        d = le(b, "paddingBottom"),
                        a = new Sd(f, e, d, a)) : (a = Wd(b, "paddingLeft"),
                            e = Wd(b, "paddingRight"),
                            f = Wd(b, "paddingTop"),
                            d = Wd(b, "paddingBottom"),
                            a = new Sd(parseFloat(f), parseFloat(e), parseFloat(d), parseFloat(a))),
                        b = de(b),
                        c.pixelWidth = h.width - b.left - a.left - a.right - b.right,
                        c.pixelHeight = h.height - b.top - a.top - a.bottom - b.bottom) : (c.pixelWidth = h.width,
                            c.pixelHeight = h.height)) : (b = b.style,
                                yb ? b.MozBoxSizing = "border-box" : zb ? b.WebkitBoxSizing = "border-box" : b.boxSizing = "border-box",
                                b.width = Math.max(h.width, 0) + "px",
                                b.height = Math.max(h.height, 0) + "px");
        return j
    }
    ; var Bg = {}
        , Cg = "ontouchstart" in document;
    function Dg(a, b, c) {
        b in Bg || (Bg[b] = new jf);
        Bg[b].Ta(a, c)
    }
    function Eg(a, b, c) {
        ...
        return sc(c, function (a) {
            return B(a, b)
        }, l, d)
    }
    function Fg(a) {
        var b = "mouseover" == a.type && "mouseenter" in Bg || "mouseout" == a.type && "mouseleave" in Bg
            , c = a.type in Bg || b;
        if ("HTML" != a.target.tagName && c) {
            if (b) {
                var b = "mouseover" == a.type ? "mouseenter" : "mouseleave", c = Bg[b], d;
                for (d in c.$) {
                    var e = Eg(b, d, a.target);
                    e && !sc(a.relatedTarget, function (a) {
                        return a == e
                    }, l) && c.va(d, e, b, a)
                }
            }
            if (b = Bg[a.type])
                for (d in b.$)
                    (e = Eg(a.type, d, a.target)) && b.va(d, e, a.type, a)
        }
    }
    Q(document, "blur", Fg, l);
    Q(document, "change", Fg, l);
    Q(document, "click", Fg);
    Q(document, "focus", Fg, l);
    Q(document, "mouseover", Fg);
    Q(document, "mouseout", Fg);
    Q(document, "mousedown", Fg);
    Q(document, "keydown", Fg);
    Q(document, "keyup", Fg);
    Q(document, "keypress", Fg);
    Q(document, "cut", Fg);
    Q(document, "paste", Fg);
    Cg && (Q(document, "touchstart", Fg),
        Q(document, "touchend", Fg),
        Q(document, "touchcancel", Fg));
    var Gg = window.yt && window.yt.uix && window.yt.uix.widgets_ || {};
    u("yt.uix.widgets_", Gg);
    function Hg(a) {
        a = a.getInstance();
        var b = Y(a);
        !(b in Gg) && a.Xc() && (a.register(),
            Gg[b] = a)
    }
    ; function Ig() {
        this.b = {}
    ...
    p.register = function () {
        $(this, "click", this.ah);
        $(this, "keydown", this.bh);
        $(this, "keypress", this.dh)
    }
        ;
    p.ah = function (a) {
        if (a && !a.disabled) {
            if (this.getData(a, "button-toggle")) {
                var b = tc(a, Y(this, "group"));
        ...
        ;
    p.bh = function (a, b, c) {
        if (!c.altKey && (!c.ctrlKey && !c.shiftKey) && (b = Kg(this, a))) {
            var d = function (a) {
                var b = "";
            ...
            if (d(b))
                ...
                var e = []
                    , d = lc(b, d, e, l) ? e[0] : k;
            if (d) {
                var d = d.tagName.toLowerCase(), f;
                "ul" == d ? f = this.lh : "table" == d && (f = this.kh);
                f && (d = t(f, this),
                    e = pe(b),
                    (f = 9 == c.keyCode) || 32 == c.keyCode || 13 == c.keyCode ? (c = Lg(this, b)) ? (a = fc(c),
                        "a" == a.tagName.toLowerCase() ? window.location = a.href : Bd(a)) : f && Mg(this, a) : e ? 27 == c.keyCode ? (Lg(this, b),
                            Mg(this, a)) : d(a, b, c) : (b = B(a, Y(this, "reverse")) ? 38 : 40,
                                c.keyCode == b && (Bd(a),
                                    c.preventDefault())))
            }
        }
        ...
        ;
    p.dh = function (a, b, c) {
        !c.altKey && (!c.ctrlKey && !c.shiftKey) && (a = Kg(this, a),
            pe(a) && c.preventDefault())
    }
        ;
    function Lg(a, b) {
    ...
    p.ee = function (a) {
        if (a) {
            ...
            if (b) {
                ...
                this.getData(a, "button-has-sibling-menu") ? a.parentNode.appendChild(b) : Qg(this, a).appendChild(b);
                b.style.minWidth = a.offsetWidth - 2 + "px";
                var c = Pg(this, a);
                c && document.body.appendChild(c);
                var c = tc(a, Y(this, "group"))
                    , d = !!this.getData(a, "button-menu-ignore-group")
                    , c = c && !d ? c : a
                    , d = 5
                    , e = 4
                    , f = je(a);
                if (B(a, Y(this, "reverse"))) {
                    d = 4;
                    e = 5;
                    f = f.top + "px";
                    try {
                ...
                B(a, "flip") && (B(a, Y(this, "reverse")) ? (d = 6,
                    e = 7) : (d = 7,
                        e = 6));
                var j;
                this.getData(a, "button-has-sibling-menu") ? j = Zd(c) : this.getData(a, "button-menu-root-container") && (j = Qg(this, a));
                D && !Mb("8") && (j = m);
                var q;
                j && (q = je(j),
                    q = new Sd(-q.top, q.left, q.top, -q.left));
                j = new db(0, 1);
                B(a, Y(this, "center-menu")) && (j.x -= Math.round((he(b).width - he(a).width) / 2));
                if (f = Pg(this, a)) {
                    var v = he(b);
            ...
            if (c) {
                ...
                N(function () {
                    ...
                    c.originalParentNode && (c.parentNode.removeChild(c),
                        ...
                        c.originalParentNode = m,
                        c.activeButtonNode = m)
                }, 1)
            }
            var e = tc(b, Y(a, "group"));
            z(b, Y(a, "active"));
            e && z(e, Y(a, "group-active"));
            if (e = a.getData(b, "button-listener"))
                wd(e),
                    ed(b, "button-listener");
            if (e = a.getData(b, "button-context-menu-listener"))
                wd(e),
                    ed(b, "button-context-menu-listener")
        }
    }
    function Rg(a, b) {
        return tc(b.activeButtonNode || b.parentNode, Y(a))
    }
    p.Kg = function (a, b) {
        var c = zd(b)
            , d = tc(c, Y(this));
        ...
        if (!tc(c, Y(this, "menu")) || B(c, Y(this, "menu-item")) || B(c, Y(this, "menu-close")))
            if (Mg(this, a),
                (d = tc(c, Y(this, "menu"))) && this.getData(a, "button-menu-indicate-selected"))
                (e = K(Y(this, "content"), a)) && kc(e, oc(c)),
    ...
    p.click = function (a) {
        if (Kg(this, a)) {
            var b = Kg(this, a)
                , c = Rg(this, b);
            c && c != a ? (Mg(this, c),
                N(t(this.ee, this, a), 1)) : pe(b) ? Mg(this, a) : this.ee(a);
            a.focus()
        }
        this.na(a, "button-action")
    }
        ;
    var Sg = zb ? "webkitTransitionEnd" : xb ? "oTransitionEnd" : "transitionend";
    function Tg() {
        this.b = {}
    }
    w(Tg, Ig);
    ...
    p.R = "expander";
    p.register = function () {
        $(this, "click", this.qh, "head");
        $(this, "keypress", this.rh, "head")
    }
        ;
    p.qh = function (a) {
        Ug(this, a)
        ...
        ;
    p.rh = function (a, b, c) {
        c && 13 == c.keyCode && Ug(this, a)
    }
        ;
    function Ug(a, b) {
        var c = a.O(b);
        c && (cb(c, Y(a, "collapsed")),
            a.na(c, "expander-action"))
    }
    function Vg(a, b) {
        var c = a.O(b);
        c && (y(c, Y(a, "collapsed")),
    ...
    p.qc = 0;
    p.register = function () {
        $(this, "mouseover", this.ae);
        $(this, "mouseout", this.Wc);
        $(this, "click", this.Wc);
        $(this, "touchstart", this.Lg);
        $(this, "touchend", this.ge);
        $(this, "touchcancel", this.ge)
    }
        ;
    p.Xc = function () {
        return !(this.Tc && 0 == Kb.indexOf("6"))
    }
        ;
    p.ae = function (a) {
        if (!(this.qc && 1E3 > qa() - this.qc)) {
            var b = parseInt(this.getData(a, "tooltip-hide-timer"), 10);
            b && (ed(a, "tooltip-hide-timer"),
                Xc(b));
            var b = t(function () {
                Xg(this, a);
                ed(a, "tooltip-show-timer")
            }, this)
    ...
    p.Lg = function (a, b, c) {
        this.qc = 0;
        a = Eg(b, Y(this), c.changedTouches[0].target);
        this.ae(a)
    }
        ;
    p.ge = function (a, b, c) {
        ...
        if (b) {
            ...
            if (c) {
                ...
                if (!d) {
                    ...
                    var j;
                    j = m;
                    sb && B(b, Y(a, "masked")) && ((j = E("yt-uix-tooltip-shared-mask")) ? (j.parentNode.removeChild(j),
                        T(j)) : (j = document.createElement("iframe"),
                            j.src = 'javascript:""',
                            j.id = "yt-uix-tooltip-shared-mask",
                            j.className = Y(a, "tip-mask")));
                    var q = $g(a, b, "content");
                    h.id = q;
    ...
    function ah(a, b, c, d, e, f) {
        ...
        f && (h = 1);
        var j = he(b);
        f = new db((j.width - 10) / 2, f ? j.height : 0);
        var q = ae(b);
        Ag(new db(q.x + f.x, q.y + f.y), c, h);
        h = Vb(window);
        q = ee(c);
        c = he(d);
        var v = c.width / 2;
    ...
    function Yg(a, b) {
        if (b) {
            ...
            if (c) {
                ...
                d && e && (d.parentNode.removeChild(d),
                    U(d),
    ...
    function ch(a, b) {
        ...
        var d = c;
        d || (d = {});
        var e = window, c = "undefined" != typeof a.href ? a.href : String(a), f = d.target || a.target, h = [], j;
        for (j in d)
            switch (j) {
                case "width":
                case "height":
            ...
            if (!b.baseUrl || !b.uid)
                ...
                if (!d && !e)
                    ...
                    if (d) {
                        ...
                        var f = [], h;
                        for (h in d)
                            f.push(encodeURIComponent(h) + "=" + encodeURIComponent(d[h]));
                        c.data = f.join(";")
                    }
                    if (e && "view" == a && b.vid && b.uid && (b.oeid || b.ieid))
                        b.oeid && (c.oeid = b.oeid),
                            b.ieid && (c.ieid = b.ieid),
                            c.evid = b.vid;
                    e && (c.foc_id = b.uid);
                    a = Ne(b.baseUrl, c)
                }
            ...
            o: function (a, c) {
                ...
                if (d) {
                    ...
                    ag(d, t(function () {
                        ...
                        a && a.createContactTools(this.zc, m, e, b)
                    }, this))
                }
            },
            D: this
    ...
    p.Qa = function () {
        ...
        Q(this.C, "submit", t(this.hf, this));
        ...
        this.zc = K("share-email-recipients", this.u);
        this.b = K("share-email-note", this.u);
        this.e = K("share-email-preview-note", this.u);
        Q(this.b, "keyup", t(this.gf, this))
    }
        ;
    p.xa = function () {
        this.C && (this.Dc && hh(this),
            this.focus())
    }
        ;
    p.focus = function () {
    ...
    p.R = "form-input";
    p.register = function () {
        D && !Mb(9) && ($(this, "click", this.mc, "checkbox"),
            $(this, "keypressed", this.mc, "checkbox"),
            $(this, "click", this.$d, "radio"),
            $(this, "keypressed", this.$d, "radio"));
        $(this, "change", this.mc, "checkbox");
        $(this, "blur", this.Ag, "select-element");
        $(this, "change", this.Ja, "select-element");
        $(this, "keyup", this.Ja, "select-element");
        $(this, "focus", this.Bg, "select-element");
        $(this, "keyup", this.Uc, "text");
        $(this, "keyup", this.Uc, "textarea");
        $(this, "keyup", this.Uc, "bidi");
        $(this, "click", this.Cg, "reset")
    }
        ;
    p.mc = function (a) {
        var b = tc(a, Y(this, "checkbox-container"));
        a.checked && B(b, "partial") && (a.checked = n,
            a.g = n,
            z(b, "partial"));
        ...
        ;
    p.yh = function (a) {
        var b = tc(a, Y(this, "radio-container"));
    ...
    p.Uc = function (a) {
        var b = a.value
            , c = "";
        Lc(b) ? c = "rtl" : Jc.test(b) && (c = "ltr");
        a.dir = c
    }
        ;
    p.Bg = function (a) {
        var b = tc(a, Y(this, "select"));
        y(b, "focused");
        this.Ja(a)
    }
        ;
    ...
    p.Ja = function (a) {
        ...
        c && ("" != b.innerHTML && c.innerHTML != b.innerHTML && this.na(a, "onchange-callback"),
            b.innerHTML = c.innerHTML)
    }
        ;
    p.Cg = function () {
        var a = ih.getInstance()
            , b = H(Y(a, "checkbox"));
        x(b, a.mc, a);
        jh();
        kh()
    ...
    ; function lh(a, b, c, d) {
        ...
        X(a, {
            ...
            o: function (a, b) {
                ...
                this.mf = b.legacy_url;
                this.lf = b.legacy_code;
                this.kf = b.iframe_url;
                this.jf = b.iframe_code;
                this.Qa();
                var c = Jd.getInstance();
                this.Oa && (this.Oa.checked = !Od(0, Rd.Hd));
                this.Nb.checked = Od(0, Rd.Gd);
                this.Na && (this.Na.checked = Od(0, Rd.Id));
                a: if (c = c.get("ems"),
                    this.pb) {
                    "custom" == c && T(E("share-embed-customize"));
                    for (var d = 0; d < this.Pa.length; d++) {
                        var q = this.Pa[d];
                        if (q.value == c) {
                            q.selected = l;
                            ih.getInstance().Ja(this.ya);
                            break a
                        }
                    }
                    ...
                    (c in this.pa ? this.pa[c] : hb(this.pa)).select();
                mh(this);
                this.xa()
            },
            D: this
    ...
    p.Qa = function () {
        ...
        if (this.pb) {
            ...
            Q(this.i, "keyup", t(this.Ie, this));
            Q(this.e, "keyup", t(this.He, this))
        } else {
            a = K("share-embed-size-list", this.u);
            b = H("share-embed-size-radio", a);
            this.pa = {};
            x(b, function (a) {
                B(a, "share-embed-size-radio-custom") || (a = new nh(a),
                    this.pa[a.name] = a)
            }, this);
            var b = hb(this.pa).width / hb(this.pa).height
                , c = K("share-embed-size-radio-custom", a)
                , b = new oh(c, b);
            this.z = this.pa[b.name] = b;
            S(a, "click", t(this.Ee, this), "share-embed-size");
            a = K("share-embed-customize", a);
            Q(a, "keyup", t(this.Je, this))
        }
        var d = {}
            , a = H("share-embed-option", this.u);
        x(a, function (a) {
            d[a.name] = a
        });
        (this.Oa = d["show-related"]) && Q(this.Oa, "click", t(this.De, this));
        this.Nb = d["delayed-cookies"];
        Q(this.Nb, "click", t(this.Be, this));
        this.k = d["use-https"];
        Q(this.k, "click", t(this.Ge, this));
        (this.Na = d["use-flash-code"] || m) && Q(this.Na, "click", t(this.Fe, this))
    }
        ;
    p.Ie = function () {
    ...
    function mh(a) {
        ...
        if (a.pb) {
            ...
            e ? "custom" == e.value ? d = {
                width: a.ib,
                height: a.zb
            } : (d = parseInt(P(e, "width"), 10),
                e = parseInt(P(e, "height"), 10),
                d = {
                    width: d,
                    height: e
                }) : d = {
        ...
        if (!d.width || 200 > d.width)
            a.pb ? (d = parseInt(P(a.Pa[0], "width"), 10),
                e = parseInt(P(a.Pa[0], "height"), 10),
                d = {
                    width: d,
                    height: e
                }) : d = hb(a.pa);
    ...
    function ph(a, b, c, d, e, f, h, j) {
        ...
        this.z && (b.new_share = 1,
            this.U && (b.render_playlist_options = 1));
        X(a, {
            format: "JSON",
            A: b,
            o: function (a, b) {
    ...
    p.Qa = function () {
        ...
        Q(a, "click", t(this.Df, this));
        a = K("share-panel-services", this.u);
        Q(a, "click", t(this.Ef, this));
        a = K("share-panel-embed", this.u);
        Q(a, "click", t(this.Bf, this));
        a = K("share-panel-email", this.u);
        Q(a, "click", t(this.Af, this));
        (a = K("share-panel-hangout", this.u)) && Q(a, "click", t(this.Cf, this));
        this.aa = K("share-panel-url", this.u);
        Q(this.aa, "click", t(this.Jf, this));
        Q(this.aa, "focus", t(function () {
            y(this.aa, "focused")
        }, this));
        Q(this.aa, "blur", t(function () {
            z(this.aa, "focused")
        }, this));
        this.ab = K("share-panel-long-url", this.u);
        this.i = K("share-panel-start-at", this.u);
        this.ga = K("share-panel-start-at-time", this.u);
        Q(this.ga, "keyup", t(this.Kf, this));
        Q(this.ga, "click", t(this.Hf, this));
        ...
        Q(this.k, "click", t(this.Wb, this));
        this.H = K("share-panel-services", this.u);
        this.N = K("share-panel-buttons", this.u);
        a = K("share-panel-show-more", this.u);
        Q(a, "click", t(this.Gf, this));
        S(this.u, "click", t(this.Ff, this), "share-service-button");
        this.z && (S(this.u, "click", t(this.Lf, this), "share-service-expand-arrow"),
            this.g = K("share-panel-services-container", this.u),
            Q(E("share-with-playlist"), "click", t(this.Of, this)),
            Q(E("share-with-playlist-current"), "click", t(this.Mf, this)),
            Q(E("share-with-playlist-first"), "click", t(this.Nf, this)))
    }
        ;
    p.Lf = function (a) {
        var b = tc(a.target, "secondary");
        a = K("overlay", b);
        var c = B(b, "expanded")
            , d = eh(a)
            , e = "rtl" == document.body.getAttribute("dir") ? "right" : "left"
            , c = c ? "0px" : he(b).width + "px";
        a.style[e] = c;
        N(function () {
            cb(b, "expanded")
        }, d)
        ...
        ;
    p.xa = function () {
        this.aa && !B(this.aa, "focused") && (this.aa.focus(),
            this.aa.select())
    }
        ;
    p.Wb = function () {
        if (!B(this.aa, "focused")) {
            var a = this.xd;
            this.ab && this.ab.checked && (a = this.wd);
            var b = {};
            ...
            if (c = !this.i.disabled)
                if (c = this.i.checked) {
                    ...
                    var f = {}
                        ...
                        , d = Ja(d, function (a) {
                            var b = (a.match(/[hms]/) || [""])[0];
                            return b ? (f[b] = parseInt(a.match(/\d+/)[0], 10),
                                n) : l
                        });
                    ...
                    if (d.length || 59 < f.s || 59 < f.m || 9 < f.h)
                        c = m;
                    else {
                        var j = "";
                        x(c, function (a) {
            ...
            c && (b.t = c);
            a = Ne(a, b);
            this.aa.value != a && (this.aa.value = a)
        }
    }
        ;
    p.Kf = function () {
    ...
    p.Af = function () {
        ...
        qe(this.b);
        !P(this.b, "disabled") && pe(this.b) && (this.ba ? this.ba.xa() : this.ba = new gh(this.b, this.cb, this.Y, this.U, this.z));
        fh("share_mail")
    }
        ;
    p.Cf = function () {
        ...
        var a = Ne("https://talkgadget.google.com/hangouts", {
            hl: this.vc,
            authuser: this.cb,
            gid: "youtube",
            gd: this.Y,
    ...
    p.Bf = function () {
        ...
        qe(this.e);
        !P(this.e, "disabled") && pe(this.e) && (this.ia ? this.ia.xa() : this.ia = new lh(this.e, this.Y, this.U, this.z));
        fh("share_embed")
    }
        ;
    p.Ff = function (a) {
        ...
        ;
    p.If = function () {
        Vg(Tg.getInstance(), this.H);
        this.b && U(this.b);
        this.e && U(this.e)
    }
        ;
    p.Df = function () {
        Vg(Tg.getInstance(), this.k);
        this.b && U(this.b);
        this.e && U(this.e)
    }
        ;
    ...
    p.Of = function (a) {
        sh(this);
        var b = n;
        a.target.checked && (b = rc(E("share-with-playlist-first"), "li"),
            b = B(b, "yt-uix-button-menu-item-selected"));
        th(this, a.target.checked, b)
    }
        ;
    function uh(a) {
    ...
    p.init = function () {
        if (!this.de) {
            ...
            this.lc = K("player-actions-container", this.Kb);
            var a = K("player-actions-close", this.lc);
            Q(a, "click", t(this.Hg, this))
        }
    }
        ;
    p.Hg = function () {
        ...
        ;
    p.Fg = function () {
        600 > this.Kb.clientWidth && y(this.lc, "small-view")
    }
        ;
    p.Vc = m;
    p.sf = function (a) {
        ...
        if (this.Vc)
            ...
            var b = K("player-actions-share", this.lc);
            this.Vc = new ph(b, a.videoId, a.listId, t(this.Fg, this), 0, 0, n, a.feature)
        }
    }
        ;
    function wh(a) {
    ...
    var xh = !D || D && 9 <= Ob
        , yh = D && !Mb("9");
    !zb || Mb("528");
    yb && Mb("1.9b") || D && Mb("8") || xb && Mb("9.5") || zb && Mb("528");
    yb && !Mb("8") || D && Mb("9");
    function zh(a, b) {
        this.type = a;
    ...
    p.handleEvent = function (a) {
        return this.b ? this.ob.call(this.Yb || this.src, a) : this.ob.handleEvent.call(this.ob, a)
    }
        ;
    var Dh = {}
        , Eh = {}
    ...
    function Hh(a, b, c, d, e) {
        ...
        a: {
            ...
            var v = Ih
                , G = xh ? function (a) {
                    return v.call(G.src, G.key, a)
                }
                    : function (a) {
                        a = v.call(G.src, G.key, a);
                        if (!a)
                            return a
                    }
                , q = G;
            ...
            Fh[f] || (Fh[f] = []);
            Fh[f].push(h);
            a.addEventListener ? (a == r || !a.Ld) && a.addEventListener(b, q, d) : a.attachEvent(b in Gh ? Gh[b] : Gh[b] = "on" + b, q);
            a = c
        }
        return a
    }
    function Jh(a, b, c, d, e) {
        if (ea(b))
            ...
            for (f = 0; f < a.length; f++)
                if (a[f].ob == c && a[f].capture == d && a[f].Yb == e) {
                    Lh(a[f].key);
                    break
                }
    }
    function Lh(a) {
        ...
        var c = b.src
            ...
            , e = b.e
            , f = b.capture;
        c.removeEventListener ? (c == r || !c.Ld) && c.removeEventListener(d, e, f) : c.detachEvent && c.detachEvent(d in Gh ? Gh[d] : Gh[d] = "on" + d, e);
        c = ja(c);
        Fh[c] && (e = Fh[c],
            Qa(e, b),
            0 == e.length && delete Fh[c]);
        b.Ua = l;
        if (b = Eh[d][f][c])
            b.Md = l,
                Mh(d, f, c, b);
    ...
    function Mh(a, b, c, d) {
        if (!d.dc && d.Md) {
            for (var e = 0, f = 0; e < d.length; e++)
                d[e].Ua ? d[e].e.src = m : (e != f && (d[f] = d[e]),
                    f++);
            d.length = f;
            d.Md = n;
            0 == f && (delete Eh[a][b][c],
                Eh[a][b].Q--,
                0 == Eh[a][b].Q && (delete Eh[a][b],
                    Eh[a].Q--),
                0 == Eh[a].Q && delete Eh[a])
        }
    }
    function Kh(a, b, c) {
        var d = Eh;
    ...
    function Ih(a, b) {
        ...
        if (!xh) {
            ...
            try {
                if (j) {
                    for (var F = [], I = v.currentTarget; I; I = I.parentNode)
                        F.push(I);
                    h = e[l];
                    h.ha = h.Q;
                    for (var R = F.length - 1; !v.Za && 0 <= R && h.ha; R--)
                        v.currentTarget = F[R],
                            f &= Nh(h, F[R], d, l, v);
                    if (q) {
                        h = e[n];
                        h.ha = h.Q;
                        for (R = 0; !v.Za && R < F.length && h.ha; R++)
                            v.currentTarget = F[R],
                                f &= Nh(h, F[R], d, n, v)
                    }
                } else
    ...
    p.dispatchEvent = function (a) {
        ...
        if (b in c) {
            ...
            if (b) {
                ...
                f = c[l];
                f.ha = f.Q;
                for (var h = e.length - 1; !a.Za && 0 <= h && f.ha; h--)
                    a.currentTarget = e[h],
                        d &= Nh(f, e[h], a.type, l, a) && a.jc != n
            }
            if (n in c)
                if (f = c[n],
                    f.ha = f.Q,
                    b)
                    for (h = 0; !a.Za && h < e.length && f.ha; h++)
                        a.currentTarget = e[h],
                            d &= Nh(f, e[h], a.type, n, a) && a.jc != n;
                else
                    for (e = this; !a.Za && e && f.ha; e = e.ic)
                        a.currentTarget = e,
                            d &= Nh(f, e, a.type, n, a) && a.jc != n;
            a = Boolean(d)
        } else
            a = l;
        return a
    ...
    p.W = function () {
        ...
        if (this == m)
            ...
            var d = ja(this);
            if (Fh[d])
                for (var d = Fh[d], e = d.length - 1; 0 <= e; e--) {
                    var f = d[e];
                    if (c || a == f.capture)
                        Lh(f.key),
                            b++
    ...
    function Th(a) {
        ...
        if (!a.Fc) {
            ...
            for (var d in a.i)
                a.b.nativeAddEventListener(d, a.i[d]);
            Wh(a) && a.H && a.Rb("SHARE_CLICKED", t(a.H.sf, a.H));
            a.Rb("onTabOrderChange", t(a.qf, a));
            a.Rb("onNavigate", t(a.rf, a));
            a.Tb && a.Tb(a.z)
        }
    }
    function Sh(a, b, c, d) {
        ...
        c = !!a.disable.flash;
        d = tb();
        (!d ? 0 : 0 <= d.toLowerCase().indexOf("android 2.2")) ? d = l : (d = document.createElement("video"),
            d = !(!d || !d.canPlayType || !d.canPlayType('video/mp4; codecs="avc1.42001E, mp4a.40.2"') && !d.canPlayType('video/webm; codecs="vp8.0, vorbis"')));
        d = d && (s("yt.player.Application") || a.assets.js);
        var e = !!a.html5;
        d || (a.args.html5_unavailable = "1");
        e && d || c ? (this.yc = this.xc,
            c || (this.Sb = this.dd)) : (this.yc = this.Qb ? this.Pe : this.dd,
                d && !b && (this.Sb = this.xc));
        this.Sb && (a.fallback = t(this.Oe, this));
        this.b = {
            addEventListener: t(this.Rb, this),
            destroy: t(this.cd, this)
        };
        a = this.ca = new jf;
        this.k || (this.k = []);
        this.k.push(a);
        this.i = {};
        this.H = Wh(this) ? new vh : m
    }
    w(Sh, gf);
    p = Sh.prototype;
    p.Fc = n;
    ...
    function Xh(a, b, c) {
        ...
        a.T = a.K.args.el;
        a.Qb = c || m;
        a.K.args.eurl || (b = document.location.toString(),
            -1 != b.indexOf("/embed/") && (b = "unknown",
                document.referrer && (b = document.referrer.substring(0, 128))),
            a.K.args.eurl = b);
        ...
        a.K.fallbackMessage = function () {
            ...
            if (!a) {
                var a = O("PLAYER_FALLBACK", k, 'The Adobe Flash Player or an HTML5 supported browser is required for video playback. <br> <a href="http://get.adobe.com/flashplayer/">Get the latest Flash Player</a> <br> <a href="/html5">Learn more about upgrading to an HTML5 browser</a>')
                    , b = navigator.userAgent.match(/Version\/(\d).*Safari/);
                b && 5 <= parseInt(b[1], 10) && (a = O("QUICKTIME_FALLBACK", k, 'The Adobe Flash Player or QuickTime is required for video playback. <br> <a href="http://get.adobe.com/flashplayer/">Get the latest Flash Player</a> <br> <a href="http://www.apple.com/quicktime/download/">Get the latest version of QuickTime</a>'))
            }
            ...
            ;
        a.Tb || (a.Tb = a.K.args.jsapicallback ? Yh(a.K.args.jsapicallback) : s("onYouTubePlayerReady"));
    ...
    p.Oe = function (a) {
        ...
        a instanceof Te || (a = new Te(a));
        delete a.fallback;
        a.html5 ? a.args.autoplay = 1 : Qf("html5_ajax", this.rg);
        this.Fc = n;
        Xh(this, a);
        dc(this.g);
        this.Sb()
    ...
    p.write = function () {
        if (!this.N) {
            ...
            a && (this.e.style.width = ge(Number(a) || a, l));
            if (a = this.K.attrs.height)
                this.e.style.height = ge(Number(a) || a, l);
            Ud(this.e, "overflow", "hidden");
            if (!this.Qb && (dc(this.g),
                Wh(this))) {
                if (a = this.K.assets.css_actions) {
                    ...
                    var b = "none" == Wd(a, "display");
                    ec(a);
                    a = !b
                }
                a && bg(this.K.assets.css_actions);
                a = Zb("div", "player-container");
                this.K.params.bgcolor && Ud(a, "background-color", this.K.params.bgcolor);
                b = Zb("div", "player-actions-container", Zb("div", "player-actions-share"), Zb("div", "player-actions-close", Zb("div", "player-actions-close-button")));
                cc(this.e, a, b);
                this.g = a;
                s("yt.tracking.shareVideo") || (u("yt.tracking.shareVideo", xg),
                    u("yt.tracking.shareList", yg));
                s("yt.window.popup") || u("yt.window.popup", dh)
            }
            this.yc()
        }
    }
    ...
    p.xc = function () {
        ...
        var app = s("yt.player.Application");

        if (app) {
            // 2012 player (constructor)
            if (typeof app === "function") {
                new app(this.g, a);
            }
            // 2014+ player (factory)
            else if (typeof app.create === "function") {
                app.create(this.g, a);
            }
            // Unknown implementation
            else {
                throw new Error("Unsupported yt.player.Application");
            }
        } else {
            ag(a.assets.js, t(this.xc, this));
        }
    }
    ;
    p.dd = function () {
        ...
        ;
    p.Pe = function () {
        ff(this.K, this.Qb.force, t(this.Ud, this))
    }
        ;
    p.Ud = function () {
        if (!this.Ma) {
    ...
    p.qf = function (a) {
        a = a ? ic : hc;
        for (var b = a(document.activeElement); b && !(1 == b.nodeType && (b.focus(),
    ...
    p.W = function () {
        ...
        ;
    var $h = s("yt.player.embed") || Rh;
    u("yt.player.embed", $h);
    var ai = s("yt.player.update") || Uh;
    u("yt.player.update", ai);
    var Zh = s("yt.player.destroy") || Vh;
    u("yt.player.destroy", Zh);
    s("ytPlayerOnYouTubePlayerReady") || u("ytPlayerOnYouTubePlayerReady", Th);
    Hg(Jg);
    Hg(Tg);
    Hg(Wg);
    function bi() { }
    ...
    p.he = m;
    p.set = function (a, b) {
        da(b) ? this.Ha.set(a, Bf(this.he, b)) : this.Ha.remove(a)
    }
        ;
    p.get = function (a) {
        a = this.Ha.get(a);
    ...
    function ki(a) {
        return !da(a) || a instanceof ji ? a : new ji(a)
    }
    ii.prototype.set = function (a, b) {
        ii.L.set.call(this, a, ki(b))
    }
        ;
    ii.prototype.b = function (a) {
        a = ii.L.get.call(this, a);
        if (!da(a) || a instanceof Object)
            return a;
        g("Storage: Invalid value was encountered")
    }
        ;
    ii.prototype.get = function (a) {
        (a = this.b(a)) ? (a = a.data,
            da(a) || g("Storage: Invalid value was encountered")) : a = k;
        return a
    }
        ;
    function li(a) {
    ...
    li.prototype.set = function (a, b, c) {
        if (b = ki(b)) {
            if (c) {
                if (c < qa()) {
                    li.prototype.remove.call(this, a);
                    return
                }
                b.expiration = c
            }
        ...
        li.L.set.call(this, a, b)
    }
        ;
    li.prototype.b = function (a, b) {
        var c = li.L.b.call(this, a);
        if (c)
            if (!b && mi(c))
                li.prototype.remove.call(this, a);
            else
    ...
    function si() {
        if (pi) {
            var a = pi
                , b = [];
            zc(a.Ha.Xa(l), function (c) {
                var d;
                try {
                    d = ni.prototype.b.call(a, c, l)
                } catch (e) {
            ...
            x(b, function (b) {
                ni.prototype.remove.call(a, b)
            })
        }
    }
    var pi = new ni(new fi);
    ei(pi.Ha) || (pi = m);
    var qi = new ni(new gi);
    ei(qi.Ha) || (qi = m);
    var ti = s("yt.timing.data_") || {};
    u("yt.timing.data_", ti);
    function ui(a, b) {
        var c = ti.timer || {};
        c[a] = b ? b : qa();
        ti.timer = c
    ...
    function vi(a) {
        ...
        ug(["https:" == window.location.protocol ? "https://gg.google.com/csi" : "http://csi.gstatic.com/csi", "?v=2&s=youtube&action=", a, e, "&", h.join("&"), "&rt=", f.join(",")].join(""))
    }
    function wi() {
        var a = L("TIMING_ACTION")
            , b = ti.timer || {};
        a && b.start && (ti.wff && -1 != a.indexOf("ajax") && b.vr && b.cl ? vi() : ti.wff && -1 == a.indexOf("ajax") && b.vr ? vi() : !ti.wff && (b.ol || b.aft) && vi())
    }
    ; function xi() {
        this.b = {}
    }
    w(xi, Ig);
    ba(xi);
    xi.prototype.R = "char-counter";
    xi.prototype.register = function () {
        $(this, "keydown", this.e, "input");
        $(this, "paste", this.e, "input");
        $(this, "cut", this.e, "input")
    }
        ;
    xi.prototype.e = function (a) {
        var b = this.O(a);
        if (b) {
            ...
            isNaN(d) || 0 >= d || N(t(function () {
                ...
                h = parseInt(this.getData(b, "warn-at-chars-remaining"), 10);
                isNaN(h) && (h = 0);
                j = d - yi(a, c);
    ...
    p = zi.prototype;
    p.Xc = function () {
        return this.Tc && 0 == Kb.indexOf("6") ? n : l
    }
        ;
    p.O = function (a) {
        var b = Ig.prototype.O.call(this, a);
        return !b ? a : b
    }
        ;
    p.getData = function (a, b) {
        var c = zi.L.getData.call(this, a, "card-config");
        return c && (c = s(c)) && c[b] ? c[b] : zi.L.getData.call(this, a, b)
    }
        ;
    p.Fb = function (a) {
        var b = this.O(a);
    ...
    function Bi(a, b, c) {
        var d = a.getData(b, "orientation") || "horizontal", e = a.getData(b, "position"), f = !!a.getData(b, "force-position"), d = "horizontal" == d, h = "bottomright" == e || "bottomleft" == e, j = "topright" == e || "bottomright" == e, q, v;
        j && h ? (v = 7,
            q = 4) : j && !h ? (v = 6,
                q = 5) : !j && h ? (v = 5,
                    q = 6) : (v = 4,
                        q = 7);
        var G = be(document.body)
            , e = be(b);
        G != e && (v ^= 2);
        var F;
        d ? (e = b.offsetHeight / 2 - 12,
            F = new db(-12, b.offsetHeight + 6)) : (e = b.offsetWidth / 2 - 6,
                F = new db(b.offsetWidth + 6, -12));
        var I = he(c)
            , e = Math.min(e, (d ? I.height : I.width) - 24 - 6);
        6 > e && (e = 6,
            d ? F.y += 12 - b.offsetHeight / 2 : F.x += 12 - b.offsetWidth / 2);
        var R = m;
        f || (R = 10);
        I = Y(a, "card-flip");
        a = Y(a, "card-reverse");
        ...
        d = d ? h ? "top" : "bottom" : !G && j || G && !j ? "left" : "right";
        ...
        h && b && (c = "right" == d ? he(c).width - e - 13 : e + 11,
            e = c / Math.sqrt(2),
            Ud(h, "left", c + "px"),
            Ud(h, "margin-left", "1px"),
            Ud(b, "margin-left", -e + "px"),
            Ud(b, "margin-top", e + "px"))
    }
    p.ka = function (a) {
        var b = this.O(a);
        if (b && (a = Ai(this, a, b)))
            z(b, Y(this, "active")),
                z(a, Y(this, "card-visible")),
                U(a),
                a.cardTargetNode = m,
                a.cardRootNode = m
    }
    ...
    p.R = "clickcard";
    p.register = function () {
        $(this, "click", this.hh, "target");
        $(this, "click", this.gh, "close")
    }
        ;
    p.hh = function (a) {
        ...
        a = b ? E(b) : a;
        b = this.O(a);
        B(b, Y(this, "active")) ? (this.ka(a),
            z(b, Y(this, "active"))) : (this.Fb(a),
                y(b, Y(this, "active")))
    }
        ;
    p.Fb = function (a) {
        ...
        Ei.L.Fb.call(this, a);
        var b = this.O(a);
        P(b, "click-outside-persists") || (this.e = a,
            this.g = Q(document, "click", t(this.Tf, this)))
    }
        ;
    p.ka = function (a) {
        Ei.L.ka.call(this, a);
        ...
        ;
    p.Tf = function (a) {
        tc(a.target, "yt-uix" + (this.R ? "-" + this.R : "") + "-card") || Fi(this)
    }
        ;
    function Fi(a) {
        a.e && (a.ka(a.e),
    ...
    p.gh = function (a) {
        (a = tc(a, Y(this, "card"))) && this.ka(a.cardTargetNode)
    }
        ;
    function Gi() {
        this.b = {}
    ...
    w(Gi, Ig);
    ba(Gi);
    Gi.prototype.R = "close";
    Gi.prototype.register = function () {
        $(this, "click", this.e)
    }
        ;
    Gi.prototype.e = function (a) {
        ...
        ;
    function Hi(a) {
        var b, c = window.location.href, d = n, e, f, h, j = n;
        h = E("page");
        var q = B(h, "watch")
            , v = a || m;
        if (!v && !q)
            return m;
        v && (f = tc(v, "context-data-container"));
        if (f)
            d = "true" == P(f, "context-open");
        else if (q && (f = E("watch-context-item-list")),
            !f)
            return m;
        a = H("context-data-item", f);
        if (!a || !a.length)
            return m;
        if (q) {
            if (j = l,
                q = E("watch-context-container"),
                h = P(q, "context-type"),
                q = K("context-back-link", q))
                c = q.href
        } else
            h = B(h, "search-base") || E("search-base-div") ? "search" : B(h, "channel") ? "channel" : B(h, "home") ? "home" : B(h, "feed") ? "feed" : "default";
        f = P(f, "context-subsource");
        if (q = E("context-source-container"))
            e = P(q, "context-source"),
                b = P(q, "context-image");
        var G = []
            , F = 0;
        x(a, function (a, b) {
    ...
    w(Ki, Ig);
    ba(Ki);
    Ki.prototype.R = "contextlink";
    Ki.prototype.register = function () {
        $(this, "click", this.e)
    }
        ;
    Ki.prototype.e = function (a) {
        var b = a.href;
        if (b) {
            var c = ye(b);
            if (c == window.location.host || !c && 0 == b.lastIndexOf("/", 0))
                if (c = Ae(b),
                    ...
                    c = Ie(b, "v");
                    if (!c) {
                        var d = (Ie(b, "video_ids") || "").split(",");
                        d && 1 < d.length && (b = parseInt(Ie(b, "index"), 10),
                            c = 0 < b ? d[b] : d[0]);
                        if (!c)
                            return
                    }
                    (a = Hi(a)) && oi("context-" + c, a, 600)
                }
        }
    }
        ;
    ...
    p.R = "hovercard";
    p.register = function () {
        $(this, "mouseenter", this.Wg, "target");
        $(this, "mouseleave", this.Yg, "target");
        $(this, "mouseenter", this.Xg, "card");
        $(this, "mouseleave", this.Zg, "card")
    }
        ;
    p.Wg = function (a) {
        if (Mi != a) {
    ...
    p.Yg = function (a) {
        ...
        ;
    p.Eg = function (a) {
        this.O(a).isCardHidable && (this.ka(a),
            Mi = m)
    }
        ;
    p.Xg = function (a) {
    ...
    p.R = "overlay";
    p.register = function () {
        $(this, "click", this.Oc, "target");
        $(this, "click", this.fc, "close")
    }
        ;
    p.Oc = function (a) {
        if (a = this.O(a)) {
            ...
            if (!c) {
                ...
                if (d) {
                    ...
                    this.getData(a, "disable-shortcuts") || (c = t(function (a) {
                        B(a.target, Y(this, "base")) && this.fc()
                    }, this),
                        Q(b, "click", c),
                        Q(document, "keydown", t(this.Yd, this)));
    ...
    p.fc = function () {
        ...
        x(a, d);
        x(c, d);
        yd(document, "keydown", t(this.Yd, this));
        b && this.na(b, "overlay-hidden")
    }
        ;
    p.Yd = function (a) {
        27 == a.keyCode && this.fc()
    }
        ;
    function Oi() {
    ...
    Pi.prototype.e = function (a) {
        if (!P(a, "redirect-href-updated")) {
            cd(a, "redirect-href-updated", "true");
    ...
    p.R = "scroller";
    p.register = function () {
        $(this, "mouseenter", this.mh);
        $(this, "mouseleave", this.nh)
    }
        ;
    p.mh = function (a) {
        var b = Q(a, "mousewheel", t(this.ih, this, a));
        this.setData(a, "scroller-mousewheel-listener", b);
        b = Q(a, "scroll", t(this.jh, this, a));
        this.setData(a, "scroller-scroll-listener", b)
    }
        ;
    p.nh = function (a) {
        wd(this.getData(a, "scroller-mousewheel-listener") || "");
        this.setData(a, "scroller-mousewheel-listener", "");
        wd(this.getData(a, "scroller-scroll-listener") || "");
    ...
    w(Ti, Ig);
    ba(Ti);
    Ti.prototype.R = "sessionlink";
    Ti.prototype.register = function () {
        $(this, "click", this.e)
    }
        ;
    Ti.prototype.e = function (a) {
        Ui(a)
    }
        ;
    function Ui(a) {
    ...
    p.R = "slider";
    p.register = function () {
        $(this, "click", this.Ug, "num");
        $(this, "click", this.Vg, "prev");
        $(this, "click", this.Tg, "next");
        $(this, "mouseover", this.$g, "ajax-trigger")
    }
        ;
    p.Ug = function (a) {
        if (a) {
            ...
            if (B(a, Y(this, "fluid"))) {
                if (a) {
                    ...
                    f ? (d = Zi(this, a, e),
                        ...
                        this.Wa(a, (0 <= b ? b : 0) + h)) : (e = $i(this, a) ? d.scrollHeight : d.scrollWidth,
                            this.Tc && 8 > document.documentMode ? Math.abs(b - h) < e && (b -= h) : d.offsetWidth < e && (b -= h),
                            aj(this, a, b))
                }
            } else if (a) {
    ...
    function Yi(a, b) {
        ...
        return $i(a, b) ? c.offsetHeight : c.offsetWidth
    }
    p.kc = function (a, b) {
        if (a)
            if (this.getData(a, "slider-ajax-url") && !this.getData(a, "slider-loaded"))
                bj(this, a, t(this.kc, this, a, b));
            else {
                var c = J(m, Y(this, "num"), a), d = Y(this, "num-current"), e;
                x(c, function (a) {
                ...
                if (c) {
                    ...
                    if (h) {
                        ...
                        f ? c.style.top = j : be(h) ? c.style.right = j : c.style.left = j
                    }
                }
                if (c = K("yt-uix-pager-current-page", a))
                    c.innerHTML = b + 1;
                this.setData(a, "slider-current", b + "");
                a && (c = parseInt(this.getData(a, "slider-current"), 10),
                    f = parseInt(this.getData(a, "slider-slides"), 10),
                    h = H(Y(this, "next"), a),
                    j = H(Y(this, "prev"), a),
                    x(h, function (a) {
                        a.disabled = n
    ...
    p.Wa = function (a, b) {
        if (a) {
            ...
            if (!(0 >= d.length)) {
                ...
                0 > b && (b = 0);
                d = d[b];
                e = be(a) ? d.offsetLeft - c + f + 10 : -1 * (d.offsetLeft - 10);
                aj(this, a, e)
            }
        }
    }
    ...
    function Zi(a, b, c) {
        ...
        1 < c.length && (c = c[1],
            d = a ? c.offsetTop - b.offsetHeight : be(b) ? b.offsetLeft - c.offsetLeft : c.offsetLeft - b.offsetLeft);
        return d
    }
    ; function cj() {
        this.b = {};
    ...
    w(cj, Ig);
    ba(cj);
    cj.prototype.R = "subscription-button";
    cj.prototype.register = function () {
        $(this, "click", this.fg);
        this.e.push(V("subscription_subscribe_loading", this.Od, this), V("subscription_subscribe_loaded", this.Nd, this), V("subscription_unsubscirbe_loading", this.Od, this), V("subscription_unsubscribe_loaded", this.Nd, this), V("subscription_subscribe_success", this.dg, this), V("subscription_unsubscribe_success", this.eg, this))
    }
        ;
    var dj = {
        eh: "yt-uix-button-subscription-container",
        fh: "yt-subscription-button-disabled-mask-container",
        Qg: "yt-uix-button-subscribe",
        Rg: "yt-uix-button-subscribed",
        Pg: "subscribed",
        ie: "hover-enabled"
    };
    p = cj.prototype;
    p.fg = function (a) {
        if (!a.getAttribute("href")) {
            ...
            this.getData(a, "is-subscribed") ? W("subscription_unsubscribe", b) : W("subscription_subscribe", b)
        }
    }
        ;
    p.Od = function (a) {
    ...
    p.eg = function (a) {
        ...
        ;
    p.ke = function (a, b) {
        b ? this.setData(a, "is-subscribed", "true") : ed(a, "is-subscribed");
        var c = this.getData(a, "style-type")
            , d = !!this.getData(a, "is-subscribed");
        if (c) {
            var c = "-" + c
                , e = dj.Rg + c;
            C(a, dj.Qg + c, !d);
    ...
    p.oc = function (a, b, c) {
        ...
        d = Sa([d], Wa(arguments, 1));
        this.vh.apply(this, d)
    }
        ;
    function ej() {
        this.b = {}
    ...
    ba(ej);
    ej.prototype.R = "tile";
    ej.prototype.register = function () {
        $(this, "click", this.e)
    }
        ;
    ej.prototype.e = function (a, b, c) {
        if (!rc(c.target, "a") && !rc(c.target, "button") && (a = K(Y(this, "link"), a)))
            D && !Mb(9) ? a.click() : (B(a, "yt-uix-sessionlink") && Ui(a),
                bh(a.href))
    }
        ;
    function fj(a, b) {
    ...
    fj.prototype.k = function (a) {
        a = a.currentTarget;
        a.disabled || (a = P(a, "action") || "",
            jj(this, a))
    }
        ;
    function jj(a, b) {
        ...
        x(c, e);
        x(d, e);
        a.g || yd(document, "keydown", t(a.i, a));
        a.ca.va("post-all");
        a.ca.va("post-" + b)
    }
    fj.prototype.i = function (a) {
        27 == a.keyCode && jj(this, "cancel")
    }
        ;
    u("yt.ui.Dialog", fj);
    function kj(a) {
    ...
    ; var lj = {}
        ...
        , qj = [];
    function rj() {
        return lj.le.y + lj.ne.height + nj
    }
    function sj(a, b) {
        pj = l;
        lj.le = b;
        ...
        mj = rj();
        tj();
        L("MEASURE_THUMBNAIL_DELAY_LOAD") && ui("tdl")
    }
    function uj(a) {
        lj.ne = a;
        vj()
    ...
    function tj(a, b) {
        pj && zj(function (a, c) {
            var f = P(a, "group-key");
            P(a, "thumb-manual") || f && !b || (f && Uf(a, f),
                f = "thumb-group-" + xj(se(a).y),
                Tf(a, c, f),
                cd(a, "group-key", f))
        }, a);
        for (var c = xj(rj()); 0 <= c; c--)
            Vf("thumb-group-" + c)
    }
    function zj(a, b) {
        var c = J("img", m, b);
    ...
    function xj(a) {
        return Math.ceil(Math.max(0, a - mj) / 400)
    }
    ; function Aj(a, b) {
        this.b = new fj(a, l);
        this.i = b;
        this.k = this.e = this.Y = ""
    }
    var Bj = m;
    function Cj(a, b, c, d) {
    ...
    Aj.prototype.z = function (a) {
        var b = Jf(a);
        a = Nf(b, "invalid_request");
        var c = Nf(b, "missing_setting_type")
            , d = Nf(b, "already_seen_dialog");
        if (!a && !c && !d)
            if (a = E("feed-privacy-dialog"),
                c = L("PLAYER_REFERENCE"),
                d = Nf(b, "success_message")) {
                var e = E("alerts")
                    , b = Nf(b, "alert_template")
                    , f = document.createElement("div");
                f.innerHTML = b;
                b = fc(f);
                if (e) {
                ...
                c && c.pauseVideo && c.pauseVideo(),
                    a.innerHTML = Nf(b, "html_content"),
                    S(a, "click", t(this.g, this, n), "make-activity-public-button"),
                    S(a, "click", t(this.g, this, l), "make-activity-private-button"),
                    yj(a),
                    gj(this.b, "content"),
                    ij(this.b)
    }
    ...
    function Ij(a) {
        ...
        this.xb = m;
        a ? (this.e(),
            this.b()) : (a = E("body-container"),
                S(a, "mousedown", t(this.e, this), "create-channel-lightbox"),
                S(a, "click", t(this.b, this), "create-channel-lightbox"))
    }
    Ij.prototype.e = function () {
        this.Gc || (bg(L("CREATE_CHANNEL_CSS_URL")),
            ag(L("CREATE_CHANNEL_JS_URL"), t(function () {
                this.Gc = l;
                this.xb && Jj(this, this.xb)
            }, this)))
    }
        ;
    Ij.prototype.g = function () {
        var a = L("CREATE_CHANNEL_NEXT_URL");
        a && ("/" == a ? bh(a) : window.history.back())
    }
        ;
    Ij.prototype.b = function (a) {
        var b = "default";
        if (a && (a = P(a.currentTarget, "upsell"),
            "upload" == a || "playlist" == a || "comment" == a))
            b = a;
        Jj(this, b)
    }
        ;
    ...
    function Tj(a) {
        ...
        a ? (b = tc(a.target, "link-gplus-lightbox"),
            Mj = B(b, "ignore-opt-out"),
            Nj = P(b, "upsell"),
            a.preventDefault()) : (Mj = n,
                Nj = "signin",
                (a = L("SIGNIN_TYPE")) && (Nj = a));
        Lj = l;
        Pj(l);
        Oj && Sj()
    }
    function Sj() {
        var a = "";
        "upload" == Nj ? a = "/my_videos_upload" : "active_signin" == Nj && (a = L("LINK_GPLUS_NEXT_URL"));
        s("yt.www.account.LinkGplusDialog.fetchAndShow")(Nj, a, Mj)
    }
    ; function Uj(a, b) {
        this.b = a;
        this.e = b;
        Q(E("premium-yva"), "click", t(this.td, this))
    }
    p = Uj.prototype;
    p.Bh = function () {
        U("ad_creative_1");
        ...
        Vj(this);
        vg("homepage_collapse_masthead_ad", k, k)
    }
        ;
    p.td = function () {
        T("ad_creative_expand_btn_1");
        ec(E("premium-yva"));
        Ud(document.getElementById("feed"), {
            "margin-top": 0
        });
        Vj(this)
    }
    ...
    p.Ah = function () {
        ...
        ;
    function Vj(a) {
        Jd.getInstance().set("HIDDEN_MASTHEAD_ID", a.b);
        Qd()
    }
    p.wh = function () {
        U("premium-yva");
        ...
        ;
    p.Ch = function () {
        Jd.getInstance().set("HIDDEN_MASTHEAD_ID", n);
        Qd();
        vg("homepage_expand_masthead_ad", k, k);
    ...
    function Yj() {
        ...
        X("/comment_servlet", {
            ...
            G: Je(Cc(b)),
            o: function (b, c) {
                c && c.html_content ? (U(K("flag-comment-step1", a)),
                    U(K("flag-comment-step2", a)),
                    T(K("flag-comment-step3", a)),
                    K("flag-comment-captcha-placeholder", a).innerHTML = c.html_content) : Ni.getInstance().fc()
            },
            onError: function (a, b) {
                var j = b && b.error_message;
                if (j) {
    ...
    ; function $j(a, b, c) {
        this.k = !!c;
        this.C = a;
        this.Aa = nd("button", m, a);
        this.Z = nd("textarea", m, a);
        this.Ra = m;
        this.b = K("comments-remaining-count", this.C);
        "CHARACTERS_REMAINING" in Pc && (this.b = K("comments-remaining", this.C));
        this.i = parseInt(P(this.b, "max-count"), 10);
        this.eb = K("comments-post-message", this.C);
        this.Zc = K("yt-alert-content", this.eb);
        this.Pb = K("comments-threshold-countdown", this.C);
        this.tc = K("comments-threshold-count", this.Pb);
        "SECONDS_REMAINING" in Pc && (this.tc = this.Pb);
        this.g = [];
        this.sc = [];
        this.e = m;
        ak(this);
        bk(this, this.Z, "focus", this.fd);
        bk(this, this.Z, "blur", this.Qe);
        bk(this, this.C, "submit", this.ed);
        bk(this, this.Z, "change", this.jd);
        bk(this, this.Z, "keyup", this.jd);
        bk(this, this.Z, "keydown", this.Re);
        b && this.fd()
    }
    function ck(a) {
        dk(a);
    ...
    function ak(a) {
        var b = a.i - a.Z.value.length;
        a.b.innerHTML = "CHARACTERS_REMAINING" in Pc ? Zc("CHARACTERS_REMAINING" in Pc ? Pc.CHARACTERS_REMAINING : {}, b) : "" + b;
        b = 0 > b;
        C(a.b, "too-many", b);
        a.Aa.disabled = b
    }
                    ...
                    switch (c) {
                        case "OK":
                            ...
                            if (this.C.reply_parent_id.value) {
                                var h = rc(this.C, m, "comments-post-container")
                                    , j = rc(h, m, "comment");
                                ec(h);
                                A(j, "replying", "has-child");
                                y(c, "child");
                                C(c, "last", !(j.nextElementSibling != k ? j.nextElementSibling : gc(j.nextSibling)));
                                j.parentNode && j.parentNode.insertBefore(c, j.nextSibling)
                            } else
                                h = rc(this.C, m, "comments-section"),
                                    h = K("comment-list", h),
                                    h.insertBefore(c, h.childNodes[0] || m),
                                    ck(this);
                            yj(c);
                            W("comment-submit-success");
                            "True" == b.show_feed_privacy_dialog && W("SHOW-COMMENT-DIALOG", L("VIDEO_ID"), b.time_created);
                            break;
                        case "PENDING":
                            dk(this);
                            this.Zc.innerHTML = O("COMMENT_PENDING");
                                ...
                                case "SHOW_COUNTDOWN":
                                    var q = parseInt(b.countdown_timer, 10) || 30
                                        , c = t(function () {
                                            0 == q ? (Yc(v),
                                                ek(this)) : (q--,
                                                    this.tc.innerHTML = "SECONDS_REMAINING" in Pc ? Zc("SECONDS_REMAINING" in Pc ? Pc.SECONDS_REMAINING : {}, q) : "" + q)
                                        }, this);
                ...
                o: function (a, d) {
                    if (d.html_content) {
                        ...
                        if (this.Xb) {
                            ...
                            this.Xb = K("yt-uix-pager-show-more", f)
                        } else
                            this.u.innerHTML = e;
                        yj(this.u);
                        if (e = E("comments-textarea"))
                            e.disabled = n,
                                e.id = "";
                        if (e = K("comment-list", this.u))
                            f = K("live-comments-setting", this.u),
                                W("comments-page-changed", e, f, b)
                    }
                    U("comments-loading")
                },
                D: this
    ...
    function gk(a, b, c) {
        a = rc(a, "form");
        fd(a, "initialized") || (cd(a, "initialized", "true"),
            Wj = new $j(a, !b, c),
            b && Wj.focus())
    }
    function hk() {
        ...
        new fk(a);
        ik.push(S(a, "click", jk, "comment-action"));
        if (a = E("comments-textarea"))
            a.disabled = n,
                a.id = "";
        L("COMMENT_OPEN_REPLY_BOX") && (a = H("comment", E("linked-comments-header")),
            kk(a[a.length - 1]))
    }
    function jk(a) {
        a = a.currentTarget;
        var b = rc(a, m, "comment");
        switch (P(a, "action")) {
            case "approve":
                a = P(b, "id");
                var c = L("VIDEO_ID");
            ...
            case "flag-in-place":
                if (mk()) {
                    ...
                    kc(K("flagged-comment-author-name", d), e);
                    K("flagged-comment-text", d).appendChild(bc(f));
                    Q(K("continue-flag-comment", d), "click", Xj);
                    S(d, "click", Yj, "submit-flag-comment");
                    S(d, "click", Zj, "abuse-type-radio-input")
                }
                break;
            case "flag":
                nk(b, "mark_comment_as_spam");
                break;
            case "flag-profile-pic":
                nk(b, "flag_profile_pic");
                break;
            case "unflag":
                a = P(b, "id");
                X("/comment_servlet", {
            ...
            case "reply":
                ...
                break;
            case "realtime-reply":
                mk() && (Wj || (a = K("comments-textarea", E("comments-view")),
                    gk(a)),
                    a = Wj,
                    ck(a),
                    a.focus());
    ...
    function mk() {
        return L("COMMENTS_SIGNIN_URL") ? (bh(L("COMMENTS_SIGNIN_URL")),
            n) : !L("COMMENTS_YPC_CAN_POST_OR_REACT_TO_COMMENT") ? n : l
    }
    function lk(a, b) {
        var c = {};
    ...
    var pk = n
        , qk = n;
    var rk = ["FL", "LL", "QL", "SV", "WL"];
    function sk() {
        return parseInt(L("SHUFFLE_VALUE"), 10) || 0
    }
    ; function tk() {
        var a = Hd("watch_queue_new");
        return a ? a.split(",") : []
    }
    function uk(a) {
        a = Wa(a, 0, 100);
        (a = a.join(",")) ? Gd("watch_queue_new", a) : Id("watch_queue_new")
    }
    ; function vk(a, b, c, d) {
        this.g = a;
        this.U = b;
    ...
    p.Va = function () {
        ...
        ;
    function xk(a) {
        return a.da() ? yk(a, "shuffled_ids", function () {
            return Ka(zk(this), function (a) {
                return a.id
            })
        }) : a.Ea()
    }
    ...
    p.Ea = function () {
        ...
        ;
    function zk(a) {
        return yk(a, "shuffled_videos", function () {
            function a(b) {
                var c = 1
                    , e = [];
    ...
    p.ea = function () {
        ...
        ;
    p.ja = function () {
        return this.da() ? Ma(zk(this), function (a) {
            return a.Ic == this.b
        }, this) : this.b
    }
        ;
    ...
    function Bk(a, b, c, d) {
        ...
        if (1 < (yk(a, "occurrences", function () {
            var a = {};
    ...
    ; function Ek(a, b, c) {
        vk.call(this, "FL", a, b, c)
    }
    w(Ek, vk);
    Ek.prototype.ec = function () {
        return "/addto_ajax?action_delete_from_favorites=1"
    }
        ;
    function Fk(a, b, c) {
        vk.call(this, "LL", a, b, c)
    }
    w(Fk, vk);
    Fk.prototype.ec = function () {
        return "/addto_ajax?action_delete_from_liked=1"
    }
        ;
    function Gk(a, b, c) {
        vk.call(this, "ML", a, b, c)
    }
    w(Gk, vk);
    ...
    p.hb = function () {
        ...
        ;
    function Jk(a, b, c) {
        vk.call(this, "SV", a, b, c);
        this.ta = l
    }
    w(Jk, vk);
    Jk.prototype.load = function (a) {
        Jk.L.load.call(this, a);
        !this.Bb() && this.Ca() && (a = xk(this),
            this.ja() >= a.length - 1 && Ck(this, m, {
                load_more: "1"
            }))
    }
        ;
    ...
    ; var Lk = "";
    function Mk() {
        Dg("addto-watch-later-button", "click", Nk);
        Dg("addto-watch-later-button-success", "click", Ok);
        Dg("addto-watch-later-button-sign-in", "click", Pk);
        S(E("shared-addto-watch-later-login"), "click", Qk, "sign-in-link")
    }
    function Pk(a) {
        Lk = P(a, "video-ids")
    }
    ...
    function Nk(a) {
        bb(a, "addto-watch-later-button", "addto-watch-later-button-loading");
        var b = P(a, "video-ids");
        X("/addto_ajax", {
            method: "POST",
            format: "XML",
            ...
            onError: function (c, d) {
                6 == d.return_code ? Rk(d.list_id, b, a) : Sk(a, d)
            }
        })
    }
    function Ok(a) {
        bb(a, "addto-watch-later-button-success", "addto-watch-later-button-loading");
        var b = P(a, "video-ids");
        X("/addto_ajax", {
            method: "POST",
            format: "XML",
            ...
            o: function () {
                bb(a, "addto-watch-later-button-loading", "addto-watch-later-button")
            },
    ...
    function Rk(a, b, c) {
        bb(c, "addto-watch-later-button-loading", "addto-watch-later-button-success");
        var d = O("ADDTO_WATCH_LATER_ADDED");
        Zg(Wg.getInstance(), c, d);
        W("WATCH_LATER_UPDATED", a, b.split(","))
    }
    function Sk(a, b) {
        bb(a, "addto-watch-later-button-loading", "addto-watch-later-button-error");
        var c = b.error_message || O("ADDTO_WATCH_LATER_ERROR");
        Zg(Wg.getInstance(), a, c)
    }
    ; function Tk(a) {
        this.e = a;
        this.b = []
            ...
            a: {
                ...
                if (b = Kh(b, c, e))
                    for (c = 0; c < b.length; c++)
                        if (!b[c].Ua && b[c].ob == d && b[c].capture == e && b[c].Yb == f) {
                            b = b[c];
                            break a
                        }
                b = m
    ...
    Zk.prototype.kb = function (a, b, c) {
    ...
    function bl(a) {
        this.J = a;
        var b, c;
        cl() ? (b = E("watch7-playlist-tray"),
            c = E("watch7-playlist-bar-title"),
            a = E("watch7-playlist-tray-item-template")) : (b = E("playlist-bar-tray"),
                c = E("playlist-bar-title"),
                a = E("playlist-bar-template"));
        this.b = b;
        this.k = c;
        this.oa = nd("ol", m, this.b);
    ...
    bl.prototype.kb = function (a, b, c, d, e, f) {
        var h = d.rb;
        h && (this.k.innerHTML = h,
            this.e && (this.e.innerHTML = d.qb));
        var j = [];
        x(a, function (a, b) {
            var e = b + f == c
                , h = d.getVideoData(a);
            h.id = a;
            h.url = Bk(d, b);
            j.push(el(this, h, b + 1 + f, e))
        }, this);
        this.oa.innerHTML = j.join("");
        e ? this.scroll(3) : this.scroll(5);
        a = H("item-count", this.J);
        x(a, function (a) {
            a.innerHTML = b
        });
        a = H("playing-index", this.J);
        x(a, function (a) {
            a.innerHTML = c + 1
        })
    }
    ...
    function el(a, b, c, d) {
        ...
        c = [];
        b.unviewable ? (c.push("playlist-bar-item-unviewable"),
            b.thumb_url = "//s.ytimg.com/yts/img/meh_mini-vfl0Ugnu3.png") : b.title || c.push("loading");
        d && c.push("playlist-bar-item-playing");
        b.classes = c.join(" ");
        return a.g.kb(b, e)
    }
    bl.prototype.Cc = function () {
        var a;
        if (cl()) {
            a = Qi.getInstance();
            var b = this.b;
            if (b)
                if (a = H(Y(a, "scroll-unit"), b),
                    0 >= a.length)
                    a = [];
                else {
                    var c = b.scrollTop
                ...
                a = []
        } else if (c = Vi.getInstance(),
            d = this.b,
            a = c.getBodyElement(d),
            a = Wi(c, a),
            a = Xi(c, a),
            a.length) {
        ...
        ;
    bl.prototype.scroll = function (a, b) {
        var c;
        c = cl() ? Qi.getInstance() : Vi.getInstance();
        switch (a) {
            case 3:
                var d = nd("li", "playlist-bar-item-playing", this.oa);
                d ? c.zd(this.b, d) : c.Wa(this.b, 0);
                break;
            case 4:
                b && c.Wa(this.b, b);
                break;
    ...
    ; function fl(a, b) {
        this.J = a;
        this.N = E("page");
        this.Ba = new bl(this.J);
        this.g = b;
        this.Bc = this.z = n;
        this.k = E("playlist-bar-bar");
        Q(this.k, "click", t(this.Xe, this));
        this.Ma = E("playlist-bar-play-button");
        Q(this.Ma, "click", t(this.cf, this));
        ...
        Q(this.ab, "click", t(this.df, this));
        Q(this.H, "click", t(this.af, this));
        this.e = E("playlist-bar-autoplay-button");
        Q(this.e, "click", t(this.We, this));
        this.T = E("playlist-bar-shuffle-button") || E("watch7-playlist-bar-shuffle-button");
        Q(this.T, "click", t(this.ef, this));
        this.ba = E("playlist-bar-toggle-button") || E("watch7-playlist-bar-toggle-button");
        Q(this.ba, "click", t(this.ff, this));
        this.i = E("playlist-bar-options-menu");
        S(this.i, "click", t(this.bf, this), "yt-uix-button-menu-item");
        this.oa = E("playlist-bar-tray-content");
        S(this.oa, "click", t(this.Ye, this), "delete");
        S(this.oa, "click", t(this.Ze, this), "load-lists");
        S(this.oa, "click", t(this.$e, this), "load-more");
        this.ia = al(E("playlist-bar-next-up-template") || E("watch7-playlist-bar-next-up-template"), ["video_encrypted_id"]);
        gl(this, b, function () {
            T("watch7-playlist-tray");
            U("watch7-playlist-loading")
        });
        this.j.ea() ? hl(this) : A(this.J, ["min", "max"], "hid");
        if (P(this.J, "masked")) {
    ...
    function gl(a, b, c, d) {
        if (a.j && (a.j.ca.clear("LIST_UPDATED"),
            a.g.isEqual(b) || d))
            b.Kc(a.g),
                a.g = b;
        a.j = b;
    ...
    p.Bb = function () {
        ...
        ;
    function hl(a) {
        Od(Jd.getInstance(), Rd.Zd) ? kl(a) : ll(a)
    }
    function kl(a) {
        A(a.J, ["hid", "max"], "min");
        ml(a, l)
    ...
    function nl(a) {
        ...
        B(a.J, "min") ? (ll(a),
            b = n) : (kl(a),
                b = l);
        vg("bf", "toggleBar=1&collapsed=" + b, k);
        Jd.getInstance();
        Pd(Rd.Zd, b);
        Qd();
        ol(a, l)
    ...
    p.bf = function (a) {
                ...
                this.Bb() || (ll(this),
                    ql(this, {
                        ...
                        o: function (a, c) {
                            A(this.J, "lists", "save");
                            var d = c.html;
                            this.Fd = E("playlist-bar-save");
                            this.Fd.innerHTML = d;
                            d = E("playlist-bar-title-edit");
                            d.focus();
                            d.select();
                            Q(E("playlist-bar-save-cancel"), "click", t(this.Yf, this));
                            Q(E("playlist-bar-save-form"), "submit", t(this.Zf, this))
                        }
                    }))
        }
    }
        ;
    p.ff = function () {
        cb(this.N, "watch-playlist-collapsed");
        nl(this)
    }
        ;
    p.We = function () {
    ...
    p.ef = function () {
        var a = !this.da()
            , b = 0;
        Sc("SHUFFLE_ENABLED", a);
        a && Sc("SHUFFLE_VALUE", Math.max(1, 1E6 * Math.random()));
        a ? (A(this.J, "shuffle-off", "shuffle-on"),
            b = sk()) : A(this.J, "shuffle-on", "shuffle-off");
        this.j.qa = b;
        this.mb();
        this.Ba.scroll(3)
    }
    ...
    p.Ye = function (a) {
        ...
        a = rc(a.currentTarget, "li", "playlist-bar-item");
        b = Ia(b, a);
        this.j.Hc() && (a = this.j.Da(),
            tl(this),
            vg("bf", "copyFrom=1&action=delete&list_type=" + a, k));
        var c = this.j.Da()
            , d = xk(this.j)[b];
        this.j.removeItem(b);
        ul(this, O("PLAYLIST_VIDEO_DELETED"), n, n, n, function () {
            this.j.Pc([d]);
            this.mb();
            var a = this.j.ea() - 1;
            this.Ba.scroll(4, a);
            this.Ba.hc([a]);
            vg("bf", "undo_delete=1&list_type=" + c, k)
        });
        vg("bf", "delete=1&list_type=" + c, k)
    }
        ;
    p.zf = function (a) {
        var b = a.sourceIndex;
        ...
        if (!(b == a || 0 > b || 0 > a)) {
            if (this.j.Hc()) {
                var c = this.j.Da();
                tl(this);
                vg("bf", "copyFrom=1&action=drag&list_type=" + c, k)
            }
            c = this.j;
            if (!c.da() && c.hb()) {
                var d = xk(c);
                d[b] && d[a] && (c.yd(b, a),
                    d = c.b,
                    d == b ? c.b = a : d > b && d <= a ? c.b -= 1 : d < b && d >= a && (c.b += 1));
                wk(c)
            }
            b = Me({
    ...
    function rl(a, b, c) {
        b || vg("bf", "autoplay=1&playcount=" + a.j.gb, k);
        var d;
        d = a.j;
        var e = d.ja() + 1;
        e >= d.ea() && (e = 0);
    ...
    function wl(a, b) {
        if (!(1 > b || 5 < b)) {
            vg("bf", "delayedautoplay=" + b, k);
            a.e && Xg(Wg.getInstance(), a.e);
            var c = O("AUTOPLAY_WARNING" + b);
            c && ul(a, c, n, l, E("watch7-playlist-container") != m)
        }
    }
    p.clear = function () {
        var a = this.j.Ea();
        this.j.clear();
        ul(this, O("LIST_CLEARED"), n, n, n, function () {
            this.j.Pc(a);
            this.mb();
            vg("bf", "undo_clear=1&list_type=" + b, k)
        });
        var b = this.j.Da();
        vg("bf", "clear=1&list_type=" + b, k)
    }
        ;
    p.Rc = function (a) {
        return this.j.Rc(a)
    ...
    p.mb = function (a) {
        ...
        a = this.j.bb;
        j = this.j.La;
        a ? ul(this, a, l, n) : j && ul(this, j, n, l);
        a = this.j;
        a.La = m;
        a.bb = m;
        ml(this);
        this.j.hb() && this.j.ea() && !this.z && (this.z = l,
            ag((L("DRAGDROP_BINARY_URL") || "") + "", t(function () {
                Q(this.oa, "mouseover", t(function () {
                    this.Bc || (this.Bc = l,
                        this.j.hb() && !this.j.da() && s("yt.www.lists.dragdrop").createDraggables())
                }, this));
                var a = s("yt.www.lists.dragdrop");
                a.init(this.oa, "playlist-bar-item");
                a.subscribe("DROPPED_AT_INDEX", this.zf, this)
            }, this)))
    }
        ;
    function ml(a, b) {
        var c = O("AUTOPLAY_OFF_TOOLTIP");
        il(a) && (c = O("AUTOPLAY_ON_TOOLTIP"));
        ...
        if (a.j.Ca()) {
            var f = xk(a.j)
                , h = a.j.ja();
            if ((f = (h = f[f.length == h + 1 ? 0 : h + 1]) && a.j.getVideoData(h)) && f.title)
                e = a.ia.kb({
    ...
    function ul(a, b, c, d, e, f) {
        b && (a.b || (a.b = E("playlist-bar-notifications"),
            S(a.b, "click", t(a.Rf, a), "playlist-bar-undo")),
            a.cc = f || m,
            a.cc && (b += ' <a class="playlist-bar-undo">' + O("UNDO_LINK") + "</a>"),
            K("yt-alert-content", a.b).innerHTML = b,
            b = K("yt-alert-icon", a.b),
            oe(b, !e),
            C(a.b, "yt-alert-error", !!c),
            C(a.b, "yt-alert-success", !c),
            T(a.b),
            a.Ia && (Xc(a.Ia),
                a.Ia = m),
            d && (c = t(function () {
    ...
    p.hc = function (a) {
        a = Ak(this.j, a);
        a.length && (this.Ba.hc(a),
            this.Ba.scroll(4, a[0]))
    }
        ;
    p.Yf = function (a) {
        a.preventDefault();
    ...
    function pl(a) {
        a.Bb() || (ll(a),
            ql(a, {
                ...
                o: function (a, c) {
                    A(this.J, "save", "lists");
                    this.mg = E("playlist-bar-lists-back");
                    this.kg = Q(this.mg, "click", t(this.ng, this));
                    var d = c.html;
                    this.Ib = E("playlist-bar-lists");
                    this.Ib.innerHTML = d;
                    yj(this.Ib);
                    this.lg = S(this.Ib, "click", t(this.og, this), "playlist-bar-playlist-item")
                }
            }))
    }
    p.og = function (a) {
    ...
    function vl(a, b, c, d) {
        ...
        e && (e = {
            ...
            c && (e.feature = c),
            a.j.da() && (e.shuffle = a.j.qa),
            d && (e.playnext = a.j.gb),
            rg(b, e));
        if (L("WATCH_CONTEXT_CLIENTSIDE") && (a = Ie(b, "v")))
            (b = Hi()) && oi("context-" + a, b, 600)
    }
    ; var yl = m
        , zl = n;
    function Al() {
        if (!yl) {
            ...
            if (a) {
                ...
                c = B(a, "editable");
                b.ta = c;
                if (c = E("playlist-bar-title") || E("watch7-playlist-bar-title"))
                    b.rb = c.innerHTML;
                if (c = E("playlist-bar-extras-menu"))
                    b.qb = c.innerHTML;
                yl = new fl(a, b)
            }
        }
    ...
    ; function Fl(a) {
        ...
        switch (a.kd) {
            case "PL":
                d = a.nd ? "action_add_to_new_playlist" : "action_add_to_playlist";
                break;
            case "FL":
    ...
    ; var Gl = !!window.DOMTokenList
        ...
        , Jl = Gl ? function (a, b) {
            ...
            : function (a, b) {
                Il(a, b) || (a.className += 0 < a.className.length ? " " + b : b)
            }
        , Kl = Gl ? function (a, b) {
            a.classList.remove(b)
        }
            : function (a, b) {
                Il(a, b) && (a.className = Ja(Hl(a), function (a) {
                    return a != b
                }).join(" "))
            }
        ;
    ...
    p.Yc = n;
    p.getId = function () {
        return this.Ed || (this.Ed = ":" + (this.Sf.b++).toString(36))
    }
        ;
    p.F = function () {
        return this.fa
    ...
    p.W = function () {
        ...
        !this.Yc && this.fa && ec(this.fa);
        this.nb = this.fa = this.Hb = this.gc = m
    }
        ;
    function Nl(a, b) {
        a.gc && x(a.gc, b, k)
    ...
    p.removeChild = function (a, b) {
        if (a) {
            ...
            a = this.Hb && c ? (c in this.Hb ? this.Hb[c] : k) || m : m;
            if (c && a) {
                var d = this.Hb;
                c in d && delete d[c];
                Qa(this.gc, a);
    ...
    w(Ol, Ml);
    Ol.prototype.i = m;
    var Pl = "placeholder" in document.createElement("input");
    p = Ol.prototype;
    p.Db = n;
    p.vd = function () {
        this.fa = this.g.Sd("input", {
            type: "text"
        })
    }
        ;
    p.uc = function (a) {
        ...
        b == a && (this.Db = l,
            Kl(this.F(), "label-input-label"));
        Pl ? this.F().placeholder = this.e : this.F().setAttribute("aria-label", this.e)
    }
        ;
    p.tb = function () {
        Ol.L.tb.call(this);
        var a = new Tk(this);
        Vk(a, this.F(), "focus", this.od);
        Vk(a, this.F(), "blur", this.tf);
        Pl ? this.b = a : (yb && Vk(a, this.F(), ["keypress", "keydown", "keyup"], this.uf),
            Vk(a, Tb(this.F()) ? Tb(this.F()).parentWindow || Tb(this.F()).defaultView : window, "load", this.vf),
            this.b = a,
            Ql(this));
        Rl(this);
        this.F().e = this
    ...
    p.Cb = function () {
        ...
        ;
    function Ql(a) {
        !a.H && (a.b && a.F().form) && (Vk(a.b, a.F().form, "submit", a.Pf),
            a.H = l)
    }
    p.W = function () {
        Ol.L.W.call(this);
    ...
    p.od = function () {
        ...
        ;
    p.tf = function () {
        Pl || (Wk(this.b, this.F(), "click", this.od),
            this.i = m);
        this.Db = n;
        Rl(this)
    }
        ;
    p.uf = function (a) {
        27 == a.keyCode && ("keydown" == a.type ? this.i = this.F().value : "keypress" == a.type ? this.F().value = this.i : "keyup" == a.type && (this.i = m),
            a.preventDefault())
    }
        ;
    p.Pf = function () {
        Sl(this) || (this.F().value = "",
            Yk(this.yg, this))
    }
        ;
    p.yg = function () {
        Sl(this) || (this.F().value = this.e)
    }
        ;
    p.vf = function () {
        Rl(this)
        ...
        ;
    function Sl(a) {
        return !!a.F() && "" != a.F().value && a.F().value != a.e
    }
    p.clear = function () {
        this.F().value = "";
        this.i != m && (this.i = "")
        ...
        ;
    function Rl(a) {
        Pl ? a.F().placeholder != a.e && (a.F().placeholder = a.e) : (Ql(a),
            a.F().setAttribute("aria-label", a.e));
        Sl(a) ? Kl(a.F(), "label-input-label") : (!a.T && !a.Db && Jl(a.F(), "label-input-label"),
            Pl || Yk(a.bg, a))
    }
    p.bg = function () {
        this.F() && (!Sl(this) && !this.Db) && (this.F().value = this.e)
    }
        ;
    function Tl(a, b, c) {
        this.b = a;
    ...
    function Ul(a, b) {
        ...
        a.se = K("note-added-message", a.b);
        a.re = K("note-added-message-title", a.b);
        ...
        a.te = Q(a.ia, "change", t(a.ue, a));
        a.ba = Q(a.i, "submit", t(a.ye, a));
        a.k = S(a.b, "click", t(a.we, a), "playlist-item-favorite");
        a.z = S(a.b, "click", t(a.xe, a), "playlist-item");
        a.Ma = S(a.b, "click", t(a.Ae, a), "save-note");
        a.T = S(a.b, "click", t(a.ve, a), "cancel-note");
        a.ab = Q(a.e, "keyup", t(a.ze, a));
        kh()
    }
    function Vl(a) {
        wd(a.te);
    ...
    p.ue = function (a) {
        ...
        var b = Ta(H("playlist-item", this.g))
    ...
    p.ug = function (a, b) {
        function c(a) {
            return fd(a, "time-created") ? (a = P(a, "time-created"),
    ...
    p.ye = function (a) {
        ...
        ta(this.e.value) || (y(b, "loading"),
            Lf(b, {
                D: this,
                o: function (a, d) {
                    z(b, "loading");
                    d.html ? (Vl(this),
                        Ul(this, d.html)) : d.errors && Wl(this, d.errors[0])
                }
            }))
    }
        ;
    ...
    p.we = function (a) {
        ...
        X("/addto_ajax", {
            ...
            o: function (a, d) {
                ...
                Xl(this, b);
                Yl(b);
                "True" == d.show_feed_privacy_dialog && W("SHOW-FAVORITE-DIALOG", this.Y)
            },
            onError: function (a, d) {
                z(b, "loading");
                Wl(this, d.error_message)
            }
        })
    }
        ;
    ...
    p.Ae = function (a) {
        a.preventDefault();
        var b = tc(a.currentTarget, "playlist-note-form");
        y(b, "loading");
        Lf(b, {
            G: {
    ...
    function $l(a, b, c, d, e, f, h) {
        ...
        window.__GOOGLEAPIS.gwidget.lang = this.vc;
        this.b && (window.__GOOGLEAPIS["googleapis.config"] = window.__GOOGLEAPIS["googleapis.config"] || {},
            window.__GOOGLEAPIS["googleapis.config"].sessionIndex = this.cb);
        ag("https://apis.google.com/js/plusone.js", t(this.i, this))
    }
    ...
    $l.prototype.g = function (a) {
        "off" != a.state && (xg("PLUS_ONE", this.z + ""),
            this.e && dh(Ne("https://plusone.google.com/_/+1/confirm", {
                url: a.url,
                source: "google:youtube"
            }), {
                width: 480,
    ...
    cm.prototype.b = function (a) {
        var b;
        a = a.currentTarget;
        var c = Jg.getInstance()
            , d = Rg(c, this.S);
        Mg(c, d);
        c = K(Y(c, "content"), d);
        d = K("label", a);
        ...
        oe(c, !!d);
        oe(E("flag-video-more-info-time"), e);
        oe(E("flag-video-more-info-hate-group"), f);
        h && ch(h, {
            target: "atmfc",
            width: 900,
            height: 700,
        ...
        a ? (U(this.C),
            dm(j)) : (cd(this.C, "result-message", j),
                T(this.C))
    }
        ;
    cm.prototype.e = function (a) {
        a.preventDefault();
    ...
    function em() {
        var a = H("flag-video-result", E("flag-video-results-container"));
        x(a, function (a) {
            U(a)
        })
    }
    ...
    function jm() {
        var a;
        if (a = E("movie_player"))
            gm || (gm = E("watch-player") || E("watch7-player")),
                a = gm && $c && 8 >= document.documentMode;
        return a
    }
    function lm(a) {
    ...
    function km() {
        fm || (fm = E("watch-video") || E("watch7-video"));
        return fm
    }
    ; var om = -1;
    function pm(a) {
        ...
        a ? (y(b, "watch-wide"),
            N(function () {
                ...
                yj(c));
        oe("masthead-utility-menulink-short", a);
        oe("masthead-utility-menulink-long", !a)
    }
    function qm(a) {
        var b = E("watch-video") || E("watch7-video");
        if (!B(E("page"), "watch-wide") || "small" == a)
            z(b, "medium", "large");
        else {
            var c = Vb(window)
    ...
    function rm(a, b, c, d) {
        ...
        if (e) {
            ...
            if (a = K("dislikes", e))
                a.innerHTML = b;
            if (b = K("watch-sparkbar-likes", e))
                b.style.width = c + "%";
            if (c = K("watch-sparkbar-dislikes", e))
                c.style.width = d + "%"
        }
    }
    function sm() {
    ...
    function tm(a) {
        rc(a.target, "BUTTON") || a.currentTarget.click()
    }
    ; var um, vm;
    function wm() {
    ...
    function ym(a) {
        if (!L("LOGGED_IN")) {
            ...
            0 === a ? vg("logged-out-like", b, k) : 1 === a && vg("logged-out-dislike", b, k)
        }
        if (L("ALLOW_RATINGS")) {
            if (b = !zm())
                L("YPC_CAN_RATE_VIDEO") ? b = n : (Am("watch-actions-rental-required"),
                    b = l),
                    b = !b;
            if (b)
                if (L("YPC_SHOW_VPPA_CONFIRM_RATING") && !confirm(O("VPPA_CONFIRM")))
                    Bm();
                else {
                    2 !== a && Cm();
                    xm(n);
                    ...
                    var c = L("VIDEO_ID")
                        , b = b = {
                            ...
                            o: function (b, e) {
                                ...
                                0 === a ? (A(f, "unliked", "liked"),
                                    "True" == e.show_feed_privacy_dialog && W("SHOW-LIKE-DIALOG", c)) : 1 === a ? A(f, "liked", "unliked") : z(f, "liked", "unliked");
                                2 !== a && (Em(e.html_content),
                                    yj(E("watch-actions-ajax")));
                                Dm(a)
                            },
                            onError: Fm,
                            V: function () {
                    ...
                    Qf("watch_actions_ajax", t(bm, r, c, a, b), b.onError)
                }
        } else
            Am("watch-actions-ratings-disabled")
    }
    function Dm(a) {
    ...
    function Mm() {
        var a = m;
        El() && E("share-with-playlist").checked && (a = zl ? Al().Va() : m);
        return a
    }
    function Nm(a, b) {
        if (Hm(a)) {
    ...
    function Om(a, b, c) {
        var d = Lm("watch-actions-share-panel");
        a != Im || b != Jm ? (Im = a,
            Jm = b,
            Am("watch-actions-share"),
            T("watch-actions-share-loading"),
            W("watch-actions-player-sidebar-height-changed"),
            U("watch-actions-share-panel"),
            um = new ph(d, a, b, function () {
                U("watch-actions-share-loading");
                Am("watch-actions-share-panel")
            }
                , 0, 0, n, "player_detailpage")) : (Am("watch-actions-share"),
                    Am("watch-actions-share-panel"),
                    um.xa(),
                    W("watch-actions-player-sidebar-height-changed"));
        c ? vg("shareOpenedFromFlash", k, k) : vg("shareOpenedFromActionBar", k, k);
        var e = sm()
            , f = Wc(function () {
                ...
                if (!e || !a)
                    ...
                    for (var a = [], b = Math.floor(e.getCurrentTime()); 0 < b;)
                        a.unshift(b % 60),
                            b = Math.floor(b / 60);
                    for (; 2 > a.length;)
                        a.unshift(0);
                    ...
                    a = a.join(":");
                    b = um;
                    b.ga && (!B(b.ga, "focused") && !b.T) && (b.ga.value = a,
                        b.Wb())
                }
            }, 1E3);
        fh("share")
    ...
    function Cm() {
        Am("watch-actions-loading");
        W("watch-actions-player-sidebar-height-changed")
    }
    function Em(a) {
        Lm("watch-actions-ajax").innerHTML = a;
        Am("watch-actions-ajax")
    }
    function Fm(a, b) {
        var c = b && (b.error_message || b.errors && b.errors[0]);
        c || (c = O("WATCH_ERROR_MESSAGE"));
        Lm("watch-error-string").innerHTML = c;
        Am("watch-actions-error")
    }
    var Pm = {};
    function Lm(a) {
        a in Pm || (Pm[a] = E(a));
    ...
    function Am(a) {
        var b = Lm("watch-actions-area-container");
        a = Lm(a);
        var c = Lm("watch-actions-loading")
            , d = Lm("watch-actions-area");
        pe(b) || (b.style.height = "0px",
            T(b));
        U(c);
        T(a);
        y(b, "transitioning");
        ...
        N(function () {
            b.style.height == e && (z(b, "transitioning"),
                b.style.height = "auto")
        }, 500)
    }
    function Bm() {
        var a = Lm("watch-actions-area-container");
        U(a);
        a = H("watch-actions-panel", a);
        x(a, function (a) {
            U(a)
        });
        W("watch-actions-player-sidebar-height-changed");
        Lm("watch-actions-ajax").innerHTML = "";
        var a = Lm("watch-actions")
            , b = Lm("watch-subactions")
            , a = J("button", m, a);
        b && (b = J("button", m, b),
            Ua(Ta(a), Ta(b)));
        x(a, function (a) {
    ...
    function zm() {
        return !L("LOGGED_IN") ? (Am("watch-actions-logged-out"),
            l) : n
    }
    ; var Qm, Rm, Sm;
    function Tm(a) {
        ...
        this.P = this.i.split(",");
        da(Sm) || (Sm = B(this.S, "lightweight-panel"));
        (a = K("sign-in", this.S)) ? Q(a, "click", t(this.Te, this)) : (a = {
            action_get_dropdown: "1"
        },
            this.g && (a.feature = this.g),
            X("/addto_ajax", {
                yb: l,
                format: "XML",
                method: "GET",
                ...
                o: function (a, c) {
                    ...
                    this.Qa();
                    var d = [];
                    Ua(d, H("playlist-name", this.B.list));
                    x(d, function (a) {
                        function b(a) {
                            var c = [], d;
                        ...
                        v || (v = q.innerHTML.replace(/^\s+|\s+$/, ""),
                            cd(q, "original-html", v));
                        for (var q = /<[^>]+>/g, G = v.match(q) || [], q = v.replace(q, "<wbr>").split("<wbr>"), F = d.innerHTML, I = "", R = 0; 1 > R; R++)
                            I += "&nbsp;<br>";
                        d.innerHTML = I;
                        I = d.clientHeight || d.offsetHeight;
                        d.innerHTML = F;
                        for (var F = 0, R = q.join("").length + 1, Da = []; F < R;) {
                            var pa = F + Math.round((R - F) / 2), Z;
                            Z = pa;
                            for (var Pa = [], qc = 0, sp = q.length; qc < sp && 0 < Z; qc++) {
                                var mm = q[qc];
                                Pa.push(mm.substring(0, Z));
                                Z -= mm.length
                            }
                            Z = Pa;
                            d.innerHTML = b(Z);
                            Pa = (d.clientHeight || d.offsetHeight) <= I;
                            d.innerHTML = "";
                            Pa ? (Da = Z,
                                F = pa + 1) : R = pa - 1
                        }
                        ...
                        q = c.innerHTML != d;
                        c.innerHTML = d;
                        q && (a = tc(a, "yt-uix-button-menu-item"),
                            a.title = P(a, "possible-tooltip"))
                    })
                }
            }))
    }
    ...
    p.Qa = function () {
        ...
        this.B.Jc = E("addto-list-saved-panel");
        this.B.bc = E("addto-list-error-panel");
        this.B.Fa = E("addto-note-input-panel");
        this.B.ud = E("addto-note-saving-panel");
        this.B.Jd = E("addto-note-saved-panel");
        this.B.Lc = E("addto-note-error-panel");
        this.B.wa = E("addto-create-panel");
        this.e = this.B.list;
        S(this.B.list, "click", t(this.Wf, this), "yt-uix-button-menu-item");
        this.Ub = K("playlist-save-note", this.B.Fa);
        Q(this.Ub, "click", t(this.Xf, this));
        var a = K("close-button", this.S);
        Q(a, "click", t(this.Vf, this))
    }
        ;
    p.Wf = function (a) {
        a.stopPropagation();
        ...
        switch (a) {
            case "create-playlist":
                Um(this, this.B.wa, l);
                this.Qd = K("addto-create-playlist", this.B.wa);
                this.Rd = K("addto-create-playlist-label", this.B.wa);
                this.Ob = K("create-playlist-button", this.B.wa);
                this.Mc = K("privacy-form", this.B.wa);
                S(this.Mc, "click", t(this.Nc, this), "playlist-privacy-option");
                ed(this.S, "video-ids");
                var d = E("addto-create-playlist");
                Q(d, "keydown", t(this.Nc, this));
                Q(d, "paste", t(this.Nc, this));
                Vm(this.B.wa, function () {
                    d.focus()
                });
            ...
            case "playlist":
                Xm(this, "PL", c),
                    1 < this.P.length ? Ym(this, b) : Zm(this, b)
        }
    }
        ;
    function Ym(a, b) {
        K("addto-title", a.B.Jc).innerHTML = b;
    ...
    function Vm(a, b) {
        if (b) {
            var c = zb ? "webkitTransitionEnd" : xb ? "oTransitionEnd" : yb ? "transitionend" : D && Mb(10) ? "MSTransitionEnd" : m;
            c ? vd(a, c, function () {
                b()
            }) : b()
        }
    ...
    p.Vd = function (a) {
        ...
        N(t(function () {
            var a = ta(b.value);
            a ? T(c) : U(c);
            !a && this.U && this.Ec ? od(this.Ub, l) : od(this.Ub, n)
        }, this), 0)
    }
        ;
    function Um(a, b, c) {
        ...
        A(a.e, d, c);
        A(b, d, c);
        Sm && b == a.B.list && y(a.S, "lightweight-panel");
        B(b, "dismissed-panel") ? (z(b, "dismissed-panel"),
            z(a.e, "active-panel")) : bb(a.e, "active-panel", "dismissed-panel");
        y(b, "active-panel");
        a.e = b
    }
    p.qg = function () {
        var a = this.Qd.value;
        this.gg = l;
        var b = parseInt(Hc(this.Mc), 10);
        Xm(this, "PL", m, a, b);
        1 < this.P.length ? Wm(this) : Zm(this, a)
    }
        ;
    p.Nc = function () {
        N(t(function () {
            var a = ta(this.Qd.value);
            a ? T(this.Rd) : U(this.Rd);
            var b = Hc(this.Mc);
            a || !b ? od(this.Ob, n) : od(this.Ob, l)
        }, this), 0)
    }
        ;
    p.Vf = function () {
    ...
    function Xm(a, b, c, d, e) {
        ...
        if ((b = rc(a.b, "a", m)) && b.href)
            b = Ke(b.href),
                d.link_feature = b.feature || "";
        d = Me(d);
        vg("addto", d, k);
        a.k && fh("add_to_playlist")
    }
    p.Ve = function (a, b) {
        this.U = b.list_id || "";
        this.Ec = b.setvideo_id || "";
        ...
        if (this.U && this.Ec) {
            ...
            dc(e);
            e.appendChild(f);
            ta(E("addto-note").value) || od(this.Ub, l)
        }
        if (!this.k && (d = tc(this.b, "ux-thumb-wrap")))
            (e = K("video-in-quicklist", d)) && ec(e),
                e = document.createElement("span"),
                e.className = "video-in-quicklist",
                e.innerHTML = c,
                d.appendChild(e);
        c = O("PLAYLIST_BAR_ADDED_TO_PLAYLIST");
        this.H && (c = O("PLAYLIST_BAR_ADDED_TO_FAVORITES"));
        Cl(this.z, this.U, c, m, this.P.length, this.P)
    }
        ;
    p.Ue = function (a, b) {
        var c = b && b.error_message;
        if (c) {
            K("error-details", this.B.bc).innerHTML = c;
            var c = K("show-menu-link", this.B.bc)
                , d = Q(c, "click", t(function (a) {
                    a.preventDefault();
                    wd(d);
                    z(this.B.Fa, "dismissed-panel", "fade", "slide");
                    z(this.B.Jc, "dismissed-panel", "fade", "slide");
                    a = K("close-note", this.S);
                    U(a);
                    this.gg ? Um(this, this.B.wa, l) : Um(this, this.B.list, l)
                }, this));
            if (c = E("addto-create-name"))
                c.disabled = n;
            z(this.B.bc, "dismissed-panel", "fade", "slide");
            Um(this, this.B.bc)
        } else
            Wm(this);
        this.k && Fm(0, b)
    ...
    p.ag = function () {
        ...
        K("panel-content", this.B.Jd).appendChild(b);
        Um(this, this.B.Jd);
        N(t(function () {
            Yg(Wg.getInstance(), b);
            Wm(this)
    ...
    p.$f = function (a, b) {
        var c = b && b.errors;
        if (c) {
            var d = K("error-details", this.B.Lc);
            dc(d);
            x(c, function (a) {
            ...
            var c = K("add-note-link", this.B.Lc)
                , e = Q(c, "click", t(function (a) {
                    a.preventDefault();
                    wd(e);
                    z(this.B.ud, "dismissed-panel");
                    Um(this, this.B.Fa)
                }, this));
            Um(this, this.B.Lc)
        } else
    ...
    function mn(a) {
        return fn(fn(kn, "H", hn()), a, hn())
    }
    ; var nn = fn(kn, "perf", hn());
    fn(nn, "g", hn());
    var on = fn(nn, "i", hn());
    fn(nn, "r", []);
    hn();
    ...
    function pn(a, b, c) {
        b && 0 < b.length && (b = qn(b),
            c && 0 < c.length && (b += "___" + qn(c)),
            28 < b.length && (b = b.substr(0, 28) + (b.length - 28)),
            c = b,
            b = fn(on, "_p", hn()),
            fn(b, c, hn())[a] = (new Date).getTime(),
            b = nn.r,
    ...
    sn.push([tn.th, function (a) {
        for (var b in a)
            if (Object.prototype.hasOwnProperty.call(a, b)) {
                var c = a[b];
                "object" == typeof c ? kn[b] = fn(kn, b, []).concat(c) : fn(kn, b, c)
            }
        if (b = a[tn.uh])
            a = fn(kn, "us", []),
                a.push(b),
    ...
    var un = decodeURI("%73cript");
    rn.m = function (a) {
        var b = kn.ms || "https://apis.google.com";
        a = a[0];
        var c;
        if (!(c = !a))
            c = 0 <= a.indexOf("..");
    ...
    function wn(a, b) {
        for (var c = [], d = 0; d < a.length; ++d) {
            var e = a[d];
            e && 0 > gn.call(b, e) && c.push(e)
        }
        return c
    }
    var xn = /^[\/_a-zA-Z0-9,.\-!:=]+$/
        , yn = /^https?:\/\/[^\/\?#]+\.google\.com(:\d+)?\/[^\?#]+$/
        , zn = /\/cb=/g
        , An = /\/\//g;
    function Bn(a) {
        var b = bn.createElement(un);
        b.setAttribute("src", a);
        b.async = "true";
        a = bn.getElementsByTagName(un)[0];
    ...
    function Dn(a, b, c) {
        function d(a, b) {
            ...
            an.clearTimeout(F);
            R.push.apply(R, pa);
            var d = ((jn || {}).config || {}).update;
            d ? d(v) : v && fn(kn, "cu", []).push(v);
            if (b) {
                pn("me0", a, Da);
                try {
                    En(function () {
                        var a;
                        a = c === ln() ? fn(jn, "_", hn()) : hn();
                        a = fn(mn(c), "_", a);
                        b(a)
                    })
                } finally {
        ...
        var q = b[tn.nc]
            ...
            , F = m
            , I = n;
        (f && !G || !f && G) && g("Timeout requires both the timeout parameter and ontimeout parameter to be set");
        var e = fn(mn(c), "r", []).sort()
            , R = fn(mn(c), "L", []).sort()
            , Da = [].concat(e);
        0 < f && (F = an.setTimeout(function () {
            I = l;
            G()
        }, f));
        var pa = wn(a, R);
        if (pa.length) {
            ...
            if (pa.length) {
                ...
                jn[qc] = function (a) {
                    ...
                    ;
                a = c.split(";");
                (a = (f = rn[a.shift()]) && f(a)) || g("Bad hint:" + c);
                f = a = a.replace("__features__", vn(pa)).replace(/\/$/, "") + (e.length ? "/ed=1/exm=" + vn(e) : "") + ("/cb=gapi." + qc);
                h = f.match(An);
                j = f.match(zn);
                (!j || !(1 === j.length && yn.test(f) && xn.test(f) && h && 1 === h.length)) && g("Bad URL " + a);
                e.push.apply(e, pa);
                pn("ml0", pa, Da);
                b[tn.Og] || an.___gapisync ? (b = a,
                    "loading" != bn.readyState ? Bn(b) : bn.write("<" + un + ' src="' + encodeURI(b) + '"></' + un + ">")) : Bn(a)
            } else
                Z[Pa](dn)
        } else
            d(pa)
    ...
    function Gn() {
        if (-2 == Fn) {
            Fn = parseInt(Hd("ACTIVITY", "-1"), 10);
            Q(document, "keypress", Hn);
            Q(document, "click", In);
    ...
    function Kn() {
        return -1 == Fn || -2 == Fn ? -1 : Math.max(qa() - Fn, 0)
    }
    ...
    Ln.prototype.load = function (a) {
        iframes.setHandler("iframe-style", Mn(this, a, this.i, n));
        iframes.setHandler("onepick", Mn(this, a, this.z, l));
        var b = {
            setNotificationWidgetHeight: t(function (a) {
                this.of.style.height = a
            }, this),
            setNotificationText: t(function (a) {
                this.pf(parseInt(a, 10))
            }, this),
    ...
    Ln.prototype.e = function () {
        return Vb(window).height - 60 - 20
    }
        ;
    function On(a, b) {
        b ? Nn(a.b, "onActive") : Nn(a.b, "onIdle")
    }
    ; function Pn(a, b, c) {
        this.g = this.e = n;
        this.z = 0;
        ...
        this.H = nd("SPAN", "yt-uix-button-content", E("sb-button-notify"));
        this.k = E("sb-onepick-target");
        this.b = new Ln("sb-target", "sb-onepick-target", t(this.Ne, this), a, b, c);
        this.b.load({
            hideNotificationWidget: t(this.$c, this),
            showOnepick: t(this.Me, this),
            hideOnepick: t(this.Le, this)
        });
        this.N = he(this.k);
        this.bd();
        Q(window, "resize", t(this.bd, this));
        Q(window, "click", t(this.$c, this));
        Gn();
        Wc(t(this.Ke, this), 12E4)
    }
    p = Pn.prototype;
    p.oh = function (a) {
        if (this.e)
            ...
            Nn(b.b, "onShowNotificationsOnly", c);
            this.e = l;
            On(this.b, n)
        }
        Ad(a)
    ...
    p.ph = function (a) {
        if (this.g)
            ...
            -1 != c.indexOf("/watch?") && Nn(b.b, "setPrefill", {
                items: [{
    ...
    function Sn(a, b, c) {
        c = "sb-card-" + c;
        b ? (A(a.u, "sb-off", "sb-on"),
            y(a.u, c)) : (A(a.u, "sb-on", "sb-off"),
                z(a.u, c))
    }
    function Rn(a) {
    ...
    p.Le = function () {
        ...
        ;
    p.bd = function () {
        var a = Math.max((Vb(window).height - this.N.height) / 2, 0);
        Ud(this.k, "top", a + "px")
    }
        ;
    p.Ke = function () {
        6E5 < Kn() ? On(this.b, n) : On(this.b, l)
    }
        ;
    function Un(a, b) {
        this.e = l;
    ...
    p.init = function () {
        for (var a = this.u, b = ["filter-crumb", "yt-close"], c = [], d = 0; d < b.length; ++d) {
            ...
            if (c.length)
                ...
                for (var f = [], h = 0; h < c.length; ++h)
                    for (var j = H(e, c[h]), q = 0; q < j.length; ++q)
                        f.push(j[q]);
                c = f
            }
        }
        x(c, this.hg, this);
        a = this.g;
        S(a, "mouseover", t(this.jg, this), "filter-content");
        S(a, "mouseout", t(this.ig, this), "filter-content")
    }
        ;
    p.hg = function (a) {
        vd(a, "click", t(this.xh, this), n)
    }
        ;
    p.xh = function (a) {
        y(tc(a.target, "filter-crumb"), "filter-crumb-removed")
    }
        ;
    function Vn(a) {
        if (!a.b) {
    ...
    p.jg = function (a) {
        ...
        ;
    p.ig = function (a) {
        Wn(a.target) && (a = Vn(this),
            z(a, "filter-crumb-active"),
            this.e = l)
    }
        ;
    p.Qf = function () {
        ...
        ;
    function Xn(a) {
        S(a, "mouseover", t(Yn, a), "group-header");
        S(a, "mouseout", t(Zn, a), "group-header")
    }
    function Yn() {
        y(this, "header-hover")
    }
    ...
    ; function $n(a) {
        ...
        N(function () {
            ...
            W("subscription_subscribe_success", a)
        }, 1E3)
    }
    function ao(a) {
    ...
    p = co.prototype;
    p.init = function () {
        var a = tc(this.ua, "yt-subscription-button-hovercard")
            , b = t(this.sg, this)
            , c = t(this.tg, this)
            , b = Q(a, "mouseenter", b);
        this.g.push(b);
    ...
    p.tg = function () {
        ...
        ;
    p.pd = function () {
        var a = Li.getInstance(), b;
        if (b = !this.Kd)
            b = a.O(this.ua),
                b = !b ? n : B(b, Y(a, "active"));
        b && (this.Kd = l,
            b = {
            ...
            X("/subscription_ajax", {
                ...
                D: this,
                o: function (b, d) {
                    Di(a, this.ua, d.response.html_content);
                    this.wb()
                },
                onError: function () {
                    this.Kd = n
        ...
        ;
    p.wb = function () {
        var a = Li.getInstance()
            , b = a.O(this.ua)
            , c = Ci(a, b);
        x(c.getElementsByTagName("input"), function (a) {
            var b = t(function () {
                Lf(c.getElementsByTagName("form")[0])
            }, this);
            a = Q(a, "change", b);
            this.g.push(a)
        }, this)
    ...
    function eo(a) {
        ...
        this.la = P(a, "enable-hovercard") ? new co(this.M, this.jb) : m;
        this.Ab = n;
        this.e = [];
        this.b = [];
    ...
    function fo(a) {
        a = H("yt-subscription-button-js-default", a);
        x(a, function (a) {
            P(a, "subscription-initialized") || (new eo(a),
                cd(a, "subscription-initialized", "true"))
        })
    }
    var go = [];
    p = eo.prototype;
    p.getId = function () {
        ...
        ;
    function ho(a, b) {
        b ? cd(a.M, "subscription-id", b) : ed(a.M, "subscription-id");
        io(a)
    }
    function io(a) {
        if (fd(a.M, "subscription-button-type")) {
            var b = "-" + P(a.M, "subscription-button-type");
            C(a.M, "yt-uix-button-subscribed" + b, !!a.getId());
            C(a.M, "yt-uix-button-subscribe" + b, !a.getId())
        } else
            C(a.M, "subscribed", !!a.getId());
        a.getId() ? (b = tc(a.M, "yt-uix-button-subscription-container"),
            vd(b, "mouseleave", t(function () {
                y(this.M, "hover-enabled")
            }, a))) : z(a.M, "hover-enabled");
        if (a.la) {
            var b = a.la
                , c = !!a.getId()
                , d = Y(Li.getInstance(), "target");
            C(b.ua, d, c);
            b = a.la;
            a = !!a.getId();
            (b.b = a) || Li.getInstance().ka(b.ua)
        }
    }
    p.wb = function () {
        this.e.push(Q(this.M, "click", t(this.wf, this)));
        this.b.push(V("SUBSCRIBE", this.xf, this));
        this.b.push(V("UNSUBSCRIBE", this.yf, this));
        ...
        ;
    function jo(a, b, c, d) {
        c != a.getId() && a.jb == b && ho(a, c);
        d == a && a.la && (a = a.la,
            Li.getInstance().ka(a.ua))
    }
    p.wf = function (a) {
        if (this.Ab)
            return n;
        a.preventDefault();
        this.getId() ? this.ce() : this.Ta()
    }
        ;
    function ko(a) {
    ...
    p.Ta = function () {
        ...
        this.Ab = l;
        ko(this);
        if (M("subscription_ajax"))
            lo(b, a, c, this);
        else if (!this.M.getAttribute("href")) {
            var d = t(this.xg, this)
                , a = Ge("/signin?context=popup", "next", document.location.protocol + "//" + document.domain + "/post_login")
                , a = Ge(a, "feature", "sub_button");
            if (a = window.open(a, "loginPopup", "width=375,height=440,resizable=yes,scrollbars=yes", l))
                b = V("LOGGED_IN", function (a) {
                    var b = L("LOGGED_IN_PUBSUB_KEY", b);
                    lf(b);
                    d(a)
                }),
                    Sc("LOGGED_IN_PUBSUB_KEY", b),
                    a.moveTo((screen.width - 375) / 2, (screen.height - 440) / 2)
        }
    }
        ;
    p.xg = function (a) {
        Uc("subscription_ajax", a.subscription_ajax);
        this.Ta()
    }
        ;
    function lo(a, b, c, d) {
        ...
        c && (e.feature = c);
        e[bo(b)] = a;
        d && d.Vb && (c = Pe("/subscription_ajax", e),
            f = Je(d.Vb),
            rg(c, f));
        c = {};
        ...
        X("/subscription_ajax", {
            ...
            o: function (c, d) {
                var e = d || {}, f, G = b;
                f = Ja(go, function (b) {
                    return b.type == G && b.jb == a
                });
                x(f, function (b) {
                    W("SUBSCRIBE", a, e, b)
                });
                e.response.show_feed_privacy_dialog && W("SHOW-SUBSCRIBE-DIALOG", a)
            },
            V: function () {
                d && (d.Ab = n,
                    d.enable())
    ...
    p.xf = function (a, b, c) {
        ...
        a == this.jb && (ho(this, b),
            this.la && (a = this.la,
                a.e && (Li.getInstance().Fb(a.ua),
                    a.pd())))
    }
        ;
    p.yf = function (a, b) {
        jo(this, a, b.response.id, this)
    }
        ;
    function mo() {
        var a = new fi;
        a && ei(a) && (this.b = new hi(a))
    }
    w(mo, gf);
    mo.prototype.b = m;
    function no(a) {
    ...
    function po(a, b, c) {
        ...
        a.saw_ad && (b.saw_ad = "1");
        c && (b.agcid = c);
        return Ne("http://www.gstatic.com/youtube/followonevent/l", b)
    }
    ; function qo(a, b, c) {
    ...
    qo.prototype.i = function (a, b) {
        b.success ? this.N.innerHTML = b.html : alert(b.errors)
    }
        ;
    qo.prototype.H = function () {
        X("/radio_ajax", {
            A: {
                action_skip_video: 1,
                station_id: this.g,
            ...
            if (0 == a || 120 >= b || b + 120 >= a) {
                if (b = zo())
                    a = Hd(b, "").split(","),
                        ...
                        0 == a.length ? Id(b) : Gd(b, a.join(","), 1814400)
    ...
    function Co() {
        ...
        if (a) {
            ...
            0 == c || 20 >= a || ug("/save_resume_204?" + Me({
                v: b,
                t: a.toString()
            }))
        }
    ...
    function Eo(a, b) {
        if ($c && !a.addEventListener) {
            ...
            a.addEventListener("onStateChange", Fo),
                a.addEventListener("onVolumeChange", Go),
                a.addEventListener("SHARE_CLICKED", Ho),
                a.addEventListener("SIZE_CLICKED", Io),
                a.addEventListener("onError", Jo),
                a.addEventListener("onAdvertiserVideoView", Ko),
                zo() && Q(window, "beforeunload", Bo),
                Dl(a),
                yo = new mo
    }
    function Ko(a) {
        if (ia(a))
            if (a.ad) {
                ...
                (a = po(d, "FOLLOWON_ADVIEW", a || "!agcid")) && ug(a);
                c && b && oi("aid-" + b, d, 604800)
            } else
                b = a.uid,
                    c = Le(window.location.hash).aid,
                    c = ga(c) ? c : m,
                    a = ri("aid-" + b),
                    a = !ia(a) ? m : a,
                    !c && !a ? a = m : (d = c && (!a || c != a.aid) ? {
                        channel: b,
                        aid: c,
                        origin: "SHARE"
                    } : kb(a),
                        a && "AD_VIEW" == a.origin && (d.saw_ad = l),
                        a = d),
                    a && (!c && a.aid && oo(a.aid),
                        (d = po(a, "SOCIAL_FOLLOWON_VIEW")) && ug(d),
                        b && (c && !a.saw_ad) && oi("aid-" + b, a, 604800))
    }
    function Fo(a) {
        uo = a;
        switch (a) {
    ...
    function Go(a) {
        ...
        if (b.b) {
            var c = {};
            c.volume = isNaN(a.volume) ? no(b).volume : Math.min(Math.max(a.volume, 0), 100);
            c.nonNormalized = a.nonNormalized;
            c.muted = a.muted == k ? no(b).muted : a.muted;
            try {
    ...
    function Lo() {
        var a = sm();
        a && (2 == uo ? a.playVideo() : a.pauseVideo())
    }
    function Mo() {
        var a = sm();
        if (a) {
    ...
    ; var To = ["ypc-container", "ypc-unsubscribe-link", "ypc-rap-overlay-link"];
    function Uo(a) {
        bg(L("YPC_LOADER_CSS"));
        $f(L("YPC_LOADER_JS"), function () {
    ...
    Vo.prototype.get = function () {
        ...
        ;
    Vo.prototype.z = function (a, b) {
        b.html && (this.e = b.html,
            this.b && this.k())
    }
        ;
    var Wo = [];
    ...
    if (navigator.plugins && navigator.plugins.length) {
        var ap = navigator.plugins["Shockwave Flash"];
        ap && (Yo = l,
            ap.description && (Zo = $o(ap.description)));
        navigator.plugins["Shockwave Flash 2.0"] && (Yo = l,
            Zo = "2.0.0.11")
    } else if (navigator.mimeTypes && navigator.mimeTypes.length) {
        var bp = navigator.mimeTypes["application/x-shockwave-flash"];
        (Yo = bp && bp.enabledPlugin) && (Zo = $o(bp.enabledPlugin.description))
    } else
        try {
            var cp = new ActiveXObject("ShockwaveFlash.ShockwaveFlash.7")
                , Yo = l
                , Zo = $o(cp.GetVariable("$version"))
        } catch (dp) {
            try {
                cp = new ActiveXObject("ShockwaveFlash.ShockwaveFlash.6"),
                    Yo = l,
                    Zo = "6.0.21"
            } catch (ep) {
                try {
                    cp = new ActiveXObject("ShockwaveFlash.ShockwaveFlash"),
                        Yo = l,
                        Zo = $o(cp.GetVariable("$version"))
                } catch (fp) { }
            }
    ...
    var gp = Zo;
    function hp(a) {
        return (a = a.exec(tb())) ? a[1] : ""
    }
    var ip = function () {
        if (kg)
            return hp(/Firefox\/([0-9.]+)/);
        if (D || xb)
            return Kb;
        if (pg)
            return hp(/Chrome\/([0-9.]+)/);
        if (qg)
            return hp(/Version\/([0-9.]+)/);
        if (mg || ng) {
            var a = /Version\/(\S+).*Mobile\/(\S+)/.exec(tb());
            if (a)
                return a[1] + "." + a[2]
        } else {
            if (og)
                return (a = hp(/Android\s+([0-9.]+)/)) ? a : hp(/Version\/([0-9.]+)/);
            if (lg)
                return hp(/Camino\/([0-9.]+)/)
        }
        return ""
    }();
    function jp() {
        (D ? 0 <= Ga(ip, "7") && 0 <= Ga(gp, "9") : kg ? 0 <= Ga(ip, "3.5") : qg ? 0 <= Ga(ip, "5") : pg) || U("reportbug")
    }
    ; function kp() {
        vd(E("help-button"), "click", lp, l)
    }
    function lp() {
        var a = E("help-button");
        if (a) {
    ...
    ; function mp() {
        W("page-init", Vb(window), Yb(document))
    }
    function np() {
        Xc(op);
        op = N(function () {
            W("page-resize", Vb(window))
        }, 200)
    }
    function pp() {
        var a = Yb(document);
        50 <= Math.abs(qp - a.y) && W("page-scroll", a)
    }
    var rp = []
        , op = 0
        , qp = 0;
    ...
    if (window != window.top) {
        ...
        if (window.parent != window.top)
            ...
            if (Qe(Bp))
                ...
                var Cp = Se(Ap);
                Re(Cp) || Mf("/roger_rabbit?" + ("location=" + encodeURIComponent(Ap) + "&self=" + encodeURIComponent(window.location.href) + "&user_agent=" + encodeURIComponent(navigator.userAgent)), {
                    onComplete: zp
                })
            }
        }
    ...
    function Fp(a, b, c) {
        if (!Gp) {
            ...
            e && (c = Hp(c),
                ug("/js_204?" + ("error=" + encodeURIComponent(a) + "&script=" + encodeURIComponent(b) + "&linenumber=" + encodeURIComponent(c) + "&url=" + encodeURIComponent(window.location.href))),
                Gp = l)
        }
    }
    var Gp = n;
    ...
    ; var Ip = [];
    var Jp = ra("You were shown...")
        , Kp = ra("You just watched...")
        , Lp = "";
    function Mp() {
        U("pyv-container");
    ...
    function Np(a, b, c, d) {
        var e = La(b.media_template_data, function (a) {
            return !!a.imageUrl
        });
        e && (a = {
            video_id: e.videoId,
            ...
            description1: Ea(b.line2),
            description2: Ea(b.line3),
    ...
    function Op(a) {
        if (0 == a.length)
            Pp(),
                L("PYV_TRACK_RELATED_CTR") && (Qp("watch-related", n),
                    Qp("watch-channel-videos-panel", n));
        else {
            var b = E("watch-channel-videos-panel");
            b && !L("IS_BRANDED_WATCH") && y(b, "yt-uix-expander-collapsed");
            Np("watch_related", a[0], m, function (a) {
                a = Nf(Jf(a.responseXML), "html_content") || "";
                var b = E(window.pyv_related_box_id || "watch-related");
                b && (0 != b.innerHTML.indexOf(a) && (b.insertBefore(bc(a), b.firstChild),
                    L("PYV_TRACK_RELATED_CTR") && (Qp("watch-related", l),
                        Qp("watch-channel-videos-panel", l))),
                    (a = E("pyv-watch-related-dest-url")) && a.setAttribute("href", Lp))
            })
        }
    }
    function Pp() {
        var a = H("related-video-featured");
        x(a, function (a) {
            T(a)
        })
    }
    ...
    function Sp(a, b, c) {
        x(a, function (a) {
            ...
            a.line3 = Ea(a.line3);
            a.url = Ea(a.url);
            b.imageUrl = Ea(b.imageUrl);
            b.channelName = Ea(b.channelName)
        });
        a = Bf(new Af(k), a);
        X("/pyv", {
            format: "XML",
    ...
    function Tp(a) {
        ...
        b.indexOf("#") == b.length - 1 && zb && (window.location.hash = "#!");
        var b = document.body
            , c = Rb(b)
            , d = [];
        d.push("<!DOCTYPE html>");
    ...
    function Up(a, b) {
        var c = Nf(Jf(a.responseXML), "html_content") || ""
            , d = E(window.pyv_related_box_id || "watch-related");
        d && 0 != d.innerHTML.indexOf(c) && (d.insertBefore(bc(c), d.firstChild),
            ug(b))
    }
    ; var Vp = m
        , Wp = m
    ...
    function bq(a, b) {
        var c = "ad300x250"
            , d = 300
            , e = 250;
        "video" == a && (c = "watch-longform-ad-placeholder",
            d = 300,
            e = 60,
            U("instream_google_companion_ad_div"));
    ...
    function jq(a) {
        a ? (U("watch-longform-ad-placeholder", "watch-channel-brand-div"),
            T("watch-longform-text", "watch-longform-ad", "instream_google_companion_ad_div")) : (U("ad300x250", "watch-longform-ad"),
                T("google_companion_ad_div", "watch-channel-brand-div"));
        Zp()
    }
    function kq() {
    ...
    u("yt.www.watch.ads.createGutSlot", function (a) {
        googletag && (Vp = googletag.defineSlot(a, [[300, 250], [300, 60]], "yt-gut-content"),
            Vp.set("ad_type", "flash"),
            Vp.addService(googletag.companionAds()),
    ...
    u("yt.www.watch.ads.handleSetCompanion", Yp);
    u("yt.www.watch.ads.handleSetCompanionForInstream", $p);
    u("yt.www.watch.ads.handleSetCompanionForLongform", aq);
    u("yt.www.watch.ads.handleSetCompanionForFreewheel", bq);
    u("yt.www.watch.ads.handleHideCompanion", cq);
    u("yt.www.watch.ads.handleHideCompanionForInstream", dq);
    u("yt.www.watch.ads.disablePopoutButton", gq);
    u("yt.www.watch.ads.enablePopoutButton", hq);
    u("yt.www.watch.ads.handleCloseMpuCompanion", eq);
    u("yt.www.watch.ads.updatePopoutAds", fq);
    u("yt.www.watch.ads.handleSetAfvCompanionVars", iq);
    u("yt.www.watch.ads.handleShowAfvCompanionAdDiv", jq);
    u("yt.www.watch.ads.handleHideAfvInstreamCompanionAdDiv", kq);
    u("yt.www.watch.ads.AD_LOAD_TOPIC", "watchads-adLoad");
    u("yt.www.ads.pyv.pyvWatchAfcWithPpvCallback", function (a) {
        Op(a);
        0 < a.length && (a = H("related-video-featured"),
            2 == a.length ? B(a[0], "related-video-featured-booster") ? T(a[1]) : T(a[0]) : x(a, function (a) {
                T(a)
            }))
    });
    u("yt.www.ads.pyv.pyvWatchAfcCallback", Op);
    u("yt.www.ads.pyv.pyvSearchRhsAfcCallback", function (a) {
        var b = E("pyv-ads");
        0 != a.length && b && Sp(a, b, "search_rhs")
    });
    u("yt.www.ads.pyv.pyvSearchTopAfcCallback", function (a) {
        var b = E("pyv-top-ads");
        !a.length || !b ? Rp(b) : Sp(a, b, "search_top")
    });
    u("yt.www.ads.pyv.pyvHomeAfcCallback", function (a) {
        var b, c;
        b = E("shelf-pyv-container");
        E("feed-pyv-container") ? (b = "feed",
            c = "feed-pyv-container") : b ? (b = "shelf",
                c = "shelf-pyv-container") : (b = "homepage",
                    c = "pyv-container");
        var d = E(c);
        !d || 0 == a.length ? "feed" == b || "shelf" == b ? ec(d) : Mp() : Np(b, a[0], d, function () {
            ...
            a && a.setAttribute("href", Lp);
            b && b.setAttribute("href", Lp);
            c && c.setAttribute("href", Lp);
            j && j.setAttribute("href", Lp);
            q && q.setAttribute("href", Lp);
            yj(d)
        })
    });
    u("yt.www.ads.pyv.showHomepagePpvAd", Mp);
    u("yt.www.ads.pyv.showPpvOnWatch", Pp);
    u("yt.www.ads.pyv.loadPyvIframe", Tp);
    u("yt.www.ads.pyv.loadPyvAfsScript", function (a) {
        $f("/pyv_afs_ads?query=" + a, k)
    });
    ...
    u("yt.www.ads.pyv.pyvSlotCompanionCallback", Up);
    u("yt.www.ads.pyv.backfillCompanionWithPyv", function () {
        window.pyv_backfill_vars ? Tp(window.pyv_backfill_vars) : window.pyv_backfill_with_ppv && Pp();
        window.pyv_backfill_vars = window.pyv_backfill_with_ppv = n
    });
    u("yt.www.ads.pyv.updatePyvSlotCompanionLabel", function (a) {
        var b = E("pyv-slot-companion-status-label");
        b && (b.innerText = a ? Jp : Kp)
    });
    Vc("pyv_related_box_id");
    u("setCompanion", Yp);
    u("setInstreamCompanion", $p);
    u("setLongformCompanion", aq);
    u("setFreewheelCompanion", bq);
    u("closeInPageAdIframe", cq);
    u("hideInstreamCompanion", dq);
    u("disablePopout", gq);
    u("enablePopout", hq);
    u("closeMpuCompanion", eq);
    u("updatePopAds", fq);
    u("setAfvCompanionVars", iq);
    u("showAfvCompanionAdDiv", jq);
    u("hideAfvInstreamCompanionAdDiv", kq);
    window.yt = window.yt || {};
    u("_gel", E);
    u("_hasclass", B);
    u("_addclass", y);
    ...
    u("goog.dom.getFirstElementChild", fc);
    u("goog.array.forEach", x);
    u("goog.array.indexOf", Ia);
    u("goog.array.contains", Na);
    u("yt.dom.hasAncestor", md);
    u("yt.setConfig", Sc);
    u("yt.getConfig", L);
    u("yt.setAjaxToken", Uc);
    u("yt.registerGlobal", Vc);
    u("yt.setTimeout", N);
    u("yt.setInterval", Wc);
    u("yt.clearTimeout", Xc);
    u("yt.clearInterval", Yc);
    ...
    u("yt.events.unlisten", yd);
    u("yt.events.stopPropagation", Ad);
    ...
    u("yt.events.getTarget", zd);
    u("yt.events.clear", function () {
        for (var a in sd)
            wd(a)
    });
    u("yt.events.Event", qd);
    qd.prototype.preventDefault = qd.prototype.preventDefault;
    qd.prototype.stopPropagation = qd.prototype.stopPropagation;
    u("yt.pubsub.subscribe", V);
    u("yt.pubsub.unsubscribeByKey", lf);
    u("yt.pubsub.publish", W);
    u("yt.www.init", Dp);
    u("yt.www.dispose", Ep);
    Q(window, "load", Dp);
    Q(window, "unload", Ep);
    u("yt.www.logError", Fp);
    window.onerror = Fp;
    V("init", function () {
        rp.push(Q(window, "resize", np));
        rp.push(Q(window, "scroll", pp));
        N(mp, 0)
    });
    V("dispose", si);
    V("init", si);
    ...
    u("goog.i18n.bidi.isRtlText", Lc);
    u("goog.i18n.bidi.setDirAttribute", function (a, b) {
        var c = b.value
            , d = "";
        Lc(c) ? d = "rtl" : Lc(c) || (d = "ltr");
        b.dir = d
    });
    u("yt.style.toggle", te);
    u("yt.style.setDisplayed", oe);
    u("yt.style.isDisplayed", pe);
    u("yt.style.setVisible", re);
    u("yt.net.ajax.sendRequest", Mf);
    u("yt.net.ajax.getRootNode", Jf);
    u("yt.net.ajax.getNodeValue", Nf);
    u("yt.net.delayed.register", Tf);
    u("yt.net.delayed.load", Vf);
    u("yt.net.delayed.markAsLoaded", function (a) {
        a in Rf && (Sf[a] = l)
    });
    u("yt.net.scriptloader.load", ag);
    u("yt.net.styleloader.load", function (a) {
        return bg(a)
    });
    u("goog.dom.forms.getFormDataString", Cc);
    u("yt.uri.buildQueryData", Me);
    u("yt.uri.appendQueryData", Ne);
    ...
    u("yt.www.feedback.displayLink", jp);
    V("init", jp);
    u("yt.www.help.bootstrap.init", kp);
    V("init", kp);
    u("yt.net.cookies.set", Gd);
    u("yt.net.cookies.get", Hd);
    u("yt.net.cookies.remove", Id);
    u("yt.window.redirect", bh);
    u("yt.window.popup", dh);
    V("init", function () {
        L("SBOX_JS_URL") && $f(L("SBOX_JS_URL"), function () {
    ...
    u("yt.www.watch.activity.getTimeSinceActive", Kn);
    u("yt.www.watch.activity.setTimestamp", Jn);
    ...
    u("yt.www.watch.activity.init", Gn);
    u("yt.www.watch.player.updateConfig", function (a) {
        a = a instanceof Te ? a.args : a.args;
        var b = n;
        a.jsapicallback = Do;
        var c;
        var d = Le(window.location.hash);
        (c = d.t || d.at) ? (wo.t = d.t,
            wo.at = d.at,
    ...
    u("yt.www.watch.player.init", function () {
        Po();
        Wc(Po, 1E3);
        xo.push(V("player-shortcut-rewind", No));
        xo.push(V("player-shortcut-fast-forward", Mo));
        xo.push(V("player-shortcut-play-pause", Lo))
    });
    u("yt.www.watch.player.seekTo", Oo);
    ...
    u("yt.www.watch.player.saveResumeOffset", Ao);
        ...
        if (d && (!e || !b))
            d = m,
                b && (d = Al(),
                    e = Ak(d.j, [a])[0],
                    d = e === k ? "" : Bk(d.j, e)),
                d || (d = c ? c : Pe(window.location.href, {
                    v: a,
                    feature: m
                })),
                d && bh(d)
    ...
    u("yt.www.watch.playlists.editAnnotation", function () {
        ...
        P(a, "setup") || (cd(a, "setup", "true"),
            a = K("cancel-button", a),
            Q(a, "click", function (a) {
                a.preventDefault();
                Qo()
            }))
    });
    ...
    u("yt.www.lists.addto.toggleMenu", function (a, b) {
        ...
        if (b) {
            ...
            c = P(e, "video-ids");
            d = P(a, "video-ids");
            Sm && y(e, "lightweight-panel");
            B(a, "flip") && y(e, "flip");
            d && c != d && (cd(e, "video-ids", d),
                f.innerHTML = Qm,
                new Tm(a))
        } else
            Rm && y(a, d),
    ...
    u("yt.www.lists.addtowatchlater.init", Mk);
    V("init", Mk);
    V("init", function () {
        V("livestreaming-likes-updated", rm);
        V("sandbar-crop-player", im);
        V("sandbar-uncrop-player", nm)
    });
    u("yt.www.watch.watch5.enableWide", pm);
    u("yt.www.watch.watch5.handleResize", function () {
        Xc(om);
        om = N(qm, 200)
    });
    u("yt.www.watch.watch5.updatePlayerSize", qm);
    ...
    u("yt.www.watch.watch5.handleToggleDescription", function (a) {
        if (B(a, "yt-uix-expander-collapsed"))
            vg("descriptionClosed", k, k);
        else {
    ...
    u("yt.www.watch.actions.init", function () {
        ...
        if (b) {
            ...
            N(function () {
                Lm("watch-actions-area-container").scrollIntoView()
            }, 0);
            delete a.action;
            a = Me(a) || "#!";
        ...
        if (!zm()) {
            ...
            X("/watch_ajax", {
                ...
                o: function (a, b) {
                    ...
                    Ni.getInstance().Oc(E("report-video-content"));
    ...
    u("yt.www.watch.actions.flag", Gm);
    ...
    u("yt.www.watch.actions.share", Nm);
    ...
    u("yt.www.watch.actions.addto", function (a) {
        if (Hm(a) && !zm()) {
            ...
            var b = L("VIDEO_ID");
            vm && vm.ra();
            vm = new Tl(a, b, function () {
                Am("watch-actions-addto")
            }
            )
        }
    });
    ...
    u("yt.www.watch.actions.transcript", function (a) {
        Hm(a) && (Cm(),
            s("yt.www.watch.transcript.open")(function () {
                U("watch-actions-loading");
                Am("watch-actions-transcript")
            }))
    });
    ...
    u("yt.www.lists.getState", function () {
        ...
        if (a) {
            ...
            for (var d = a.ja(), e = il(a), f = a.da() ? a.j.qa : 0, h = [], j = 0; j < b.length; j++) {
    ...
    V("init", function () {
        nj = L("THUMB_DELAY_LOAD_BUFFER") || 0;
        qj.push(V("page-init", sj));
        qj.push(V("page-resize", uj));
        qj.push(V("page-scroll", wj))
    });
    V("init", function () {
        for (var a = 0; a < document.forms.length; a++) {
            for (var b = n, c = 0; c < Ip.length; c++)
                document.forms[a].name == Ip[c] && (b = l);
            c = document.forms[a];
            if ("post" == c.method.toLowerCase() && b == n) {
                for (var b = n, d = 0; d < c.elements.length; d++)
                    c.elements[d].name == L("XSRF_FIELD_NAME") && (b = l);
                b || (b = k,
                    b = L("XSRF_TOKEN"),
    ...
    u("yt.www.masthead.toggleExpandedMasthead", function () {
        ...
        oe("masthead-expanded-menu", l);
        oe("masthead-expanded-acct-sw-container", n);
        var b = E("yt-masthead-dropdown");
        b && cb(b, "reversed");
        $m || z(E("masthead-expanded-container"), "accountswitch");
        if (!P(a, "loaded")) {
            if ((b = E("masthead-expanded-menu-gaia-photo")) && !b.src)
                b.src = P(b, "src");
            X("/playlist_bar_ajax", {
                A: {
                ...
                yb: l,
                o: function (b, d) {
                    E("masthead-expanded-lists-container").innerHTML = d.html;
                    cd(a, "loaded", "true")
                }
            })
        }
    ...
    u("yt.www.masthead.accountswitch.toggle", function () {
        qe("masthead-expanded-acct-sw-container");
        var a = E("masthead-expanded-container")
            , b = E("masthead-expanded-acct-sw-container");
        if (pe(b)) {
            b.style.top = a.offsetTop + "px";
            D && (Mb("7") && !Mb("8")) && (b.style.top = a.offsetTop - (b.offsetTop - a.offsetTop) + "px");
    ...
    V("init", function () {
        L("SANDBAR_ENABLED") && Cn("iframes", {
            callback: function () {
                var a = E("sb-button-notify")
                    , b = E("sb-button-share")
                    , c = new Pn(L("SANDBAR_LOCALE"), L("SESSION_INDEX"), L("SANDBAR_DELEGATED_SESSION_ID"));
                Q(a, "click", t(c.oh, c));
                Q(b, "click", t(c.ph, c));
                W("sandbar-init")
            },
    ...
    u("yt.www.ads.MastheadAd", Uj);
    Uj.prototype.autoCollapsePremiumYva = Uj.prototype.wh;
    Uj.prototype.collapse_ad = Uj.prototype.Bh;
    Uj.prototype.expand_ad = Uj.prototype.Ch;
    Uj.prototype.userCollapsePremiumYva = Uj.prototype.td;
    Uj.prototype.userExpandPremiumYva = Uj.prototype.zh;
    Uj.prototype.userUnexpandPremiumYva = Uj.prototype.Ah;
    ...
    u("yt.tracking.doubleclick.trackActivity", function (a, b, c) {
        ...
        c && !c.ord && (a += ";ord=1");
        for (var d in c)
            a += ";" + encodeURIComponent(String(d)) + "=" + encodeURIComponent(String(c[d]));
        a += ";num=" + qa();
    ...
    u("yt.analytics.trackEvent", bd);
    u("yt.timing.report", vi);
    u("yt.timing.maybeReport", wi);
    $c && (!document.documentMode || 8 > document.documentMode) && S(E("ie"), "click", tm, "video-thumb");
    u("yt.www.subscription.autoaction.continueAction", function (a) {
        W("subscription_subscribe", a)
    });
    V("init", function () {
        V("subscription_subscribe", $n);
        V("subscription_unsubscribe", ao)
    });
    u("yt.www.subscriptions.edit.onUpdateSubscription", function (a, b, c, d) {
        c = c || "";
        var e = n;
        (b = E("subscription_level_unsubscribe")) && b.checked && (e = l);
        b = Cc(E("subscription_level_uploads" + c).form);
        Mf("/ajax_subscriptions?" + b, {
            postBody: "session_token=" + a,
            onComplete: function (a) {
                E("subscribeMessage" + c).innerHTML = Nf(Jf(a), "html_content");
                U("edit_subscription_wrapper" + c);
                U("edit_subscription_arrow" + c);
                T("subscribeMessage" + c);
                c && (E("edit_subscription_opener" + c).style.visibility = "",
                    N(function () {
    ...
    u("yt.www.subscriptions.edit.onEditSubscriptionFromRecentActivity", function (a, b, c, d) {
        window["edit_subscription_download_" + c] ? (U("subscribeMessage" + c),
            te("edit_subscription_wrapper" + c),
            te("edit_subscription_arrow" + c),
            a = E("edit_subscription_opener" + c),
            a.style.visibility = "visible" == a.style.visibility ? "" : "visible") : (window["edit_subscription_download_" + c] = l,
                Mf("/ajax_subscriptions?get_edit_subscription_form=" + b + "&i=" + c, {
                    postBody: "session_token=" + a,
                    onComplete: function (a) {
                        E("edit_subscription_opener" + c).style.visibility = "visible";
                        var b = document.createElement("div");
                        b.innerHTML = Nf(a.responseXML, "html_content");
    ...
    u("yt.www.subscriptions.SubscriptionButton.init", fo);
    u("yt.www.subscriptions.SubscriptionButton.delayedSubscribe", function (a, b) {
        lo(a, b, "delayed-sub", m)
    });
    u("yt.www.account.FeedPrivacyDialog.init", function () {
        V("SHOW-COMMENT-DIALOG", Fj);
        V("SHOW-FAVORITE-DIALOG", Hj);
        V("SHOW-LIKE-DIALOG", Gj);
        V("SHOW-SUBSCRIBE-DIALOG", Ej)
    });
    ...
    u("yt.www.account.linkgplusloader.init", function () {
        ...
        S(a, "mousedown", Qj, "link-gplus-lightbox");
        S(a, "click", Tj, "link-gplus-lightbox")
    });
    ...
    u("yt.www.account.linkgplusloader.setWaitCursor", Pj);
    V("init", function () {
        if (L("YPC_LOADER_ENABLED")) {
            ...
            V("ypc-delayedloader-load", Uo)
        }
    });
    Vc("yt", "goog", "_gel", "googleapisv0", "_hasclass", "_addclass", "_removeclass", "_showdiv", "_hidediv", "_ajax");
    ...
    u("yt.www.watch.survey.watchPageSurveyGoAway", So);
    u("yt.www.watch.survey.checkSurveyCompletedAndShow", function () {
        Od(Jd.getInstance(), Rd.oe) || T("watch_page_survey")
    });
    ...
    Vc("getNextVideoId");
    V("init", function () {
        L("WATCH_CONTEXT_CLIENTSIDE") && Hg(Ki)
    });
}
)();
